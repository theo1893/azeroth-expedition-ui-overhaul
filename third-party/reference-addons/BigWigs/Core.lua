...
L:RegisterTranslations("zhCN", function()
	...
	["Show debug messages."] = "显示调试消息.",
	["Forces the module to reset for everyone in the raid.\n\n(Requires assistant or higher)"] = "强制对团队中所有人的模块进行重置。\n\n(需要助理或更高权限)",
	["%s has requested forced reboot for the %s module."] = "%s 已请求强制重新启动%s模块",
	bosskill_cmd = "kill",
	bosskill_name = "Boss死亡",
	bosskill_desc = "当Boss被击败时进行通告",
	...
	["Edit frame layout and alert sizes"] = "编辑框架布局和警报图标大小",
	["Close"] = "关闭",
	["First Time Popup"] = "BigWigs 现已启用！\n\n建议点击“编辑布局”来调整警报的位置和大小。如果现在不想设置，之后也可以随时右键点击 BigWigs 小地图图标并选择“编辑布局”。",
	you = "you",
	}
end)
