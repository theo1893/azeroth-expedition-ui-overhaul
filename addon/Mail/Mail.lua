...
do
	...
	function PLAYER_LOGIN()
		...
		local realmName = GetCVar('realmName') or "UnknownRealm"
		local factionGroup = UnitFactionGroup('player') or "UnknownFaction"
		local key = realmName .. '|' .. factionGroup
...
do
	...
	function GetSuggestions()
		...
		for name, time in Mail_AutoCompleteNames[key] do
