pfUI:RegisterModule("thirdparty-vanilla", "vanilla", function()
  ...
  HookAddonOrVariable("UnitXP_SP3_Addon", function()
	...
	SkinCheckbox(xpsp3_checkButton_hideCritterNameplate)
	...
	SkinCheckbox(xpsp3_checkButton_combatTextSP3)
	SkinCheckbox(xpsp3_checkButton_hideEXPtext)
	SkinCheckbox(xpsp3_checkButton_perfectScreenshot)
	...
	--[[ EditBox
	StripTextures(xpsp3_editBox_combatTextSP3_fontSize, "BACKGROUND")
	CreateBackdrop(xpsp3_editBox_combatTextSP3_fontSize)
	StripTextures(xpsp3_editBox_combatTextSP3_nameplateHeight, "BACKGROUND")
	CreateBackdrop(xpsp3_editBox_combatTextSP3_nameplateHeight)
	StripTextures(xpsp3_editBox_combatTextSP3_fontName, "BACKGROUND")
	CreateBackdrop(xpsp3_editBox_combatTextSP3_fontName)
	StripTextures(xpsp3_editBox_FPScap, "BACKGROUND")
	CreateBackdrop(xpsp3_editBox_FPScap)
	StripTextures(xpsp3_editBox_backgroundFPScap, "BACKGROUND")
	CreateBackdrop(xpsp3_editBox_backgroundFPScap)]]
  end)
