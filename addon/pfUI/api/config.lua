...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("appearance", "expedition",  "ownership",        "scoped-v1")
  pfUI:UpdateConfig("appearance", "expedition",  "vanilla_fallback", "0")
  pfUI:UpdateConfig("appearance", "expedition",  "native_blizzard_skins","0")
  pfUI:UpdateConfig("appearance", "expedition",  "legacy_info_panels","1")
  pfUI:UpdateConfig("appearance", "expedition",  "single_chat_frame","1")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "focusauras",       "1")
