local module, L = BigWigs:ModuleDeclaration("Trioch", "Timbermaw Hold")
...
local function bossTargetName()
	...
	local unit = BigWigs.TimbermawUnit(module.translatedName)
	return unit and UnitName(unit .. "target") or nil
end
...
function module:Event(msg)
	...
	if i1 then
		...
		self:IceLance(i1 and resolveName(i1), i2 and resolveName(i2) or nil)
		return
	end
end
