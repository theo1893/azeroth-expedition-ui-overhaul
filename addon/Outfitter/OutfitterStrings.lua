...
Outfitter_cTestersTitle = "Customized modifications for Turtle WoW";
Outfitter_cTestersNames = " ";
Outfitter_cSpecialThanksTitle = "Modified by：";
Outfitter_cSpecialThanksNames = "Sunelegy";
Outfitter_cGuildURL = "20231021";
