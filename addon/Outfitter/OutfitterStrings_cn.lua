...
Outfitter_cRenameOutfit = "重命名装备";

Outfitter_cCompleteOutfits = "完整的衣柜";
Outfitter_cPartialOutfits = "部分混合匹配";
Outfitter_cAccessoryOutfits = "配件";
Outfitter_cSpecialOutfits = "特殊的场合";
Outfitter_cOddsNEndsOutfits = "零碎物品";

Outfitter_cNormalOutfit = "一般";
...
Outfitter_cCityOutfit = "在城市";

Outfitter_cMountSpeedFormat = "骑行技能提高速度";
Outfitter_cMountLowFormat = "又慢又稳"; --乌龟坐骑
Outfitter_cMountFreeFormat = "骑术技能提高速度";

Outfitter_cBagsFullError = "Outfitter: 无法删除 %s 因为所有的包都已满";
Outfitter_cDepositBagsFullError = "Outfitter: 不能存入 %s 因为所有的银行包都满了";
Outfitter_cWithdrawBagsFullError = "Outfitter: 不能取 %s 因为所有的包都满了";
Outfitter_cItemNotFoundError = "Outfitter: 未发现物品 %s";
--Outfitter_cItemAlreadyUsedError = "Outfitter: 无法将 %s 放在 %s 插槽中，因为它已经在另一个插槽中使用了。";
Outfitter_cAddingItem = "Outfitter: 添加 %s 到 %s 装备";
Outfitter_cNameAlreadyUsedError = "错误：该名称已被使用。";
Outfitter_cNoItemsWithStatError = "警告：您的任何物品都没有该属性。";

Outfitter_cEnableAll = "启用所有";
Outfitter_cEnableNone = "启用无";

Outfitter_cConfirmDeleteMsg = "您确定要删除装备 %s?";
Outfitter_cConfirmRebuildMsg = "您确定要恢复装备 %s?";
Outfitter_cRebuild = "恢复";
...
Outfitter_cItemStatFormats =
{
	...
	{Format = "提高所有法术和魔法效果所造成的伤害和治疗效果，最多(%d+)点", Types = {"SpellDmg", "ShadowDmg", "FireDmg", "FrostDmg", "ArcaneDmg", "NatureDmg", "Healing"}},
	...
	{Format = "%+(%d+) 阴影法术伤害", Types = {"ShadowDmg"}},
...
Outfitter_cShowMinimapButtonOnDescription = "选取这个显示小地图的按钮";
Outfitter_cShowMinimapButtonOffDescription = "打开，如果你想显示在你的小地图按钮";
Outfitter_cRememberVisibility = "记住披风和头盔的设置";
Outfitter_cRememberVisibilityOnDescription = "反之，如果你想使用一个单一的显示/隐藏所有的斗篷和头盔的设置";
Outfitter_cRememberVisibilityOffDescription = "打开，如果你想一直记得你显示和隐藏每个单独“斗篷和头盔";
Outfitter_cShowHotkeyMessages = "显示键绑定装备更改";
Outfitter_cShowHotkeyMessagesOnDescription = "如果您不想在使用键绑定更改设备时看到消息，请关闭此选项。";
Outfitter_cShowHotkeyMessagesOffDescription = "如果您希望使用键绑定更改设备时查看消息，请打开此选项。";

Outfitter_cEquipOutfitMessageFormat = "Outfitter: %s 装备";
Outfitter_cUnequipOutfitMessageFormat = "Outfitter: %s 未装备";

Outfitter_cAboutTitle = "关于 Outfitter";
Outfitter_cAuthor = " ";
Outfitter_cTestersTitle = "乌龟服定制版";
Outfitter_cTestersNames = "Sunelegy适配";
Outfitter_cSpecialThanksTitle = "感谢测试：";
Outfitter_cSpecialThanksNames = "欧服Azshara公会";
Outfitter_cGuildURL = "适配1.17.2版本";
Outfitter_cGuildURL2 = "欢迎分享";

Outfitter_cOpenOutfitter = "打开 Outfitter";

Outfitter_cArgentDawnOutfitDescription = "这套装备将在你进入瘟疫之地时装备";
Outfitter_cRidingOutfitDescription = "这套装备将在你乘骑时装备";
Outfitter_cDiningOutfitDescription = "这套装备将在你进食或喝水时装备";
Outfitter_cBattlegroundOutfitDescription = "这套装备将在你进战场时装备";
Outfitter_cArathiBasinOutfitDescription = "这套装备将在你进阿拉希盆地战场时装备";
Outfitter_cAlteracValleyOutfitDescription = "这套装备将在你进奥特兰克山谷战场时装备";
Outfitter_cWarsongGulchOutfitDescription = "这套装备将在你进战歌峡谷战场时装备";
Outfitter_cCityOutfitDescription = "这套装备将在你进友方城镇时装备";

Outfitter_cKeyBinding = "按键绑定";

BINDING_HEADER_OUTFITTER_TITLE = Outfitter_cTitle;

BINDING_NAME_OUTFITTER_OUTFIT1  = "全套装备 1";
BINDING_NAME_OUTFITTER_OUTFIT2  = "全套装备 2";
BINDING_NAME_OUTFITTER_OUTFIT3  = "全套装备 3";
BINDING_NAME_OUTFITTER_OUTFIT4  = "全套装备 4";
BINDING_NAME_OUTFITTER_OUTFIT5  = "全套装备 5";
BINDING_NAME_OUTFITTER_OUTFIT6  = "全套装备 6";
BINDING_NAME_OUTFITTER_OUTFIT7  = "全套装备 7";
BINDING_NAME_OUTFITTER_OUTFIT8  = "全套装备 8";
BINDING_NAME_OUTFITTER_OUTFIT9  = "全套装备 9";
BINDING_NAME_OUTFITTER_OUTFIT10 = "全套装备 10";

Outfitter_cDisableOutfit = "禁用 Outfit";
Outfitter_cDisableOutfitInBG = "禁用装备在战场";
Outfitter_cDisableOutfitInInstance = "禁用装备在某些情况";
Outfitter_cDisabledOutfitName = "%s (禁用)";

Outfitter_cMinimapButtonTitle = "自动一键换装";
Outfitter_cMinimapButtonDescription = "单击以选择不同的装备或拖动来重新定位此按钮.";
...
Outfitter_cCompleteCategoryDescripton = "完整的服装有每个插槽指定的物品，将取代所有其他服装.";
Outfitter_cPartialCategoryDescription = "部分混合匹配服装只有一些槽指定,但不是全部。在装备时，他们是在顶部你选择全套补充，更换任何其他部分混合匹配或配件的服装选择.";
Outfitter_cAccessoryCategoryDescription = "配件装备只有指定的插槽，但不是全部.  不像部分混合匹配,你可以选择你喜欢的衣服很多附件他们都会结合在一起，穿上你的选择的完整和部分混合匹配服装.";
Outfitter_cSpecialCategoryDescription = "特殊的场合的服装是自动穿每当场合的需要. ";
Outfitter_cOddsNEndsCategoryDescription = "Odds 'n ends 是一个你没有用过的装备清单。  这可能是有用的，以确保您使用您的所有物品或您不携带超重行李。";

Outfitter_cRebuildOutfitFormat = "恢复 %s";

Outfitter_cTranslationCredit = " ";

Outfitter_cSlotEnableTitle = "槽启用";
Outfitter_cSlotEnableDescription = "如果您想在选择该装备时，在该槽中的项目被装备，请选择此项。如果未选中，则在更改到所选装备时，该插槽不会被修改.";
...
Outfitter_cOutfitCategoryTitle = "种类";
Outfitter_cBankCategoryTitle = "银行";
Outfitter_cDepositToBank = "将所有物品存入银行";
Outfitter_cDepositUniqueToBank = "将唯一物品存入银行";
Outfitter_cWithdrawFromBank = "从银行提取物品";

Outfitter_cMissingItemsLabel = "丢失的物品: ";
Outfitter_cBankedItemsLabel = "库存物品: ";

Outfitter_cRepairAllBags = "Outfitter: 修理所有包裹物品";

Outfitter_cStatsCategory = "统计";
Outfitter_cMeleeCategory = "近战";
Outfitter_cSpellsCategory = "治疗和法术";
Outfitter_cRegenCategory = "再生";
