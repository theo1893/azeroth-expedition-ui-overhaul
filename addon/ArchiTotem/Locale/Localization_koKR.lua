if GetLocale() == "koKR" then
	...
	-- ArchiTotem 키 바인딩
	BINDING_HEADER_ARCHITOTEM = "ArchiTotem 토템 마스터"
	BINDING_NAME_ARCHITOTEM_CASTALL = "모든 토템 설치"
	BINDING_NAME_ARCHITOTEM_RECALL = "모든 토템 회수"
	BINDING_NAME_ARCHITOTEM_CASTEARTH = "대지 토템 설치"
	BINDING_NAME_ARCHITOTEM_CASTFIRE = "화염 토템 설치"
	BINDING_NAME_ARCHITOTEM_CASTWATER = "물 토템 설치"
	BINDING_NAME_ARCHITOTEM_CASTAIR = "공기 토템 설치"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPEARTH = "대지 토템 건너뛰기 토글"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPFIRE = "화염 토템 건너뛰기 토글"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPWATER = "물 토템 건너뛰기 토글"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPAIR = "공기 토템 건너뛰기 토글"
	...
	ArchiTotemLocale = {
		...
		["Earth totems skip: ON"] = "대지 토템 건너뛰기: 켜짐",
		["Earth totems skip: OFF"] = "대지 토템 건너뛰기: 꺼짐",
		["Fire totems skip: ON"] = "화염 토템 건너뛰기: 켜짐",
		["Fire totems skip: OFF"] = "화염 토템 건너뛰기: 꺼짐",
		["Water totems skip: ON"] = "물 토템 건너뛰기: 켜짐",
		["Water totems skip: OFF"] = "물 토템 건너뛰기: 꺼짐",
		["Air totems skip: ON"] = "공기 토템 건너뛰기: 켜짐",
		["Air totems skip: OFF"] = "공기 토템 건너뛰기: 꺼짐",
		["右键点击切换跳过状态"] = "우클릭으로 건너뛰기 상태 전환",
	}
end