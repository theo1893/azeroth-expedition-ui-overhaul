if GetLocale() == "frFR" then
	...
	-- ArchiTotem 绑定
	BINDING_HEADER_ARCHITOTEM = "ArchiTotem Maître des Totems"
	BINDING_NAME_ARCHITOTEM_CASTALL = "Placer tous les totems"
	BINDING_NAME_ARCHITOTEM_RECALL = "Rappeler tous les totems"
	BINDING_NAME_ARCHITOTEM_CASTEARTH = "Placer totem de terre"
	BINDING_NAME_ARCHITOTEM_CASTFIRE = "Placer totem de feu"
	BINDING_NAME_ARCHITOTEM_CASTWATER = "Placer totem d'eau"
	BINDING_NAME_ARCHITOTEM_CASTAIR = "Placer totem d'air"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPEARTH = "Basculer ignorer totems de terre"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPFIRE = "Basculer ignorer totems de feu"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPWATER = "Basculer ignorer totems d'eau"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPAIR = "Basculer ignorer totems d'air"
	...
	ArchiTotemLocale = {
		...
		["Earth totems skip: ON"] = "Ignorer totems de terre: ACTIVÉ",
		["Earth totems skip: OFF"] = "Ignorer totems de terre: DÉSACTIVÉ",
		["Fire totems skip: ON"] = "Ignorer totems de feu: ACTIVÉ",
		["Fire totems skip: OFF"] = "Ignorer totems de feu: DÉSACTIVÉ",
		["Water totems skip: ON"] = "Ignorer totems d'eau: ACTIVÉ",
		["Water totems skip: OFF"] = "Ignorer totems d'eau: DÉSACTIVÉ",
		["Air totems skip: ON"] = "Ignorer totems d'air: ACTIVÉ",
		["Air totems skip: OFF"] = "Ignorer totems d'air: DÉSACTIVÉ",
		["右键点击切换跳过状态"] = "Clic droit pour basculer l'état d'ignorage",
	}
end