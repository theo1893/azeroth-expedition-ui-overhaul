...
if GetLocale() == "esES" then
	...
	-- ArchiTotem 键绑定
	BINDING_HEADER_ARCHITOTEM = "ArchiTotem Maestro de Tótems"
	BINDING_NAME_ARCHITOTEM_CASTALL = "Colocar todos los tótems"
	BINDING_NAME_ARCHITOTEM_RECALL = "Recuperar todos los tótems"
	BINDING_NAME_ARCHITOTEM_CASTEARTH = "Colocar tótem de tierra"
	BINDING_NAME_ARCHITOTEM_CASTFIRE = "Colocar tótem de fuego"
	BINDING_NAME_ARCHITOTEM_CASTWATER = "Colocar tótem de agua"
	BINDING_NAME_ARCHITOTEM_CASTAIR = "Colocar tótem de aire"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPEARTH = "Alternar omitir tótems de tierra"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPFIRE = "Alternar omitir tótems de fuego"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPWATER = "Alternar omitir tótems de agua"
	BINDING_NAME_ARCHITOTEM_TOGGLESKIPAIR = "Alternar omitir tótems de aire"
	...
	ArchiTotemLocale = {
		...
		["Earth totems skip: ON"] = "Omitir tótems de tierra: ACTIVADO",
		["Earth totems skip: OFF"] = "Omitir tótems de tierra: DESACTIVADO",
		["Fire totems skip: ON"] = "Omitir tótems de fuego: ACTIVADO",
		["Fire totems skip: OFF"] = "Omitir tótems de fuego: DESACTIVADO",
		["Water totems skip: ON"] = "Omitir tótems de agua: ACTIVADO",
		["Water totems skip: OFF"] = "Omitir tótems de agua: DESACTIVADO",
		["Air totems skip: ON"] = "Omitir tótems de aire: ACTIVADO",
		["Air totems skip: OFF"] = "Omitir tótems de aire: DESACTIVADO",
		["右键点击切换跳过状态"] = "Clic derecho para alternar estado de omisión",
	}
end