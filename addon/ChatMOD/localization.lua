...
SCCN_WELCOME = SCCN_WELCOME.."|cff68ccefVersion:|cffCDCDCD ".."\n\n";	
...
if ( GetLocale() == "zhCN" ) then
	...
	SCCN_GUI_HIGHLIGHT1				= "输入您需要高亮显示的信息";
	...
	SCCN_HELP[2]			= "|cff68ccef".."/chatmod hidechanname 隐藏频道名称";
	SCCN_HELP[3]			= "|cff68ccef".."/chatmod colornicks 以职业颜色显示玩家名字";
	SCCN_HELP[4]			= "|cff68ccef".."/chatmod purge 整理SCCN数据库|cffa0a0a0(每次载入此ui时都会自动执行这个动作)";
	SCCN_HELP[5]			= "|cff68ccef".."/chatmod killdb 完整地把SCCN数据库清除(无法复原)";
	SCCN_HELP[6]			= "|cff68ccef".."/chatmod mousescroll 使用鼠标滚轮滚动对话框|cffa0a0a0(SHIFT+滚轮=快翻，CTRL+滚轮=翻至尽头";
	SCCN_HELP[7]			= "|cff68ccef".."/chatmod topeditbox 对话输入框显示在聊天窗口的上面。";	
	SCCN_HELP[8]			= "|cff68ccef".."/chatmod timestamp 显示时间戳在每条信息之前 输入|cffa0a0a0 /chatmod timestamp [$t:$m:$s $p]|cffffffff 显示更改格式说明。";
	SCCN_HELP[10]			= "|cff68ccef".."/chatmod hyperlink 让对话消息里的URL可被选择复制！";
	SCCN_HELP[11]			= "|cff68ccef".."/chatmod selfhighlight 在对话消息中把自己名字明显标示！";
	SCCN_HELP[12]			= "|cff68ccef".."/chatmod clickinvite 让对话中的[邀请]能直接被点选以加入队伍";	
	SCCN_HELP[13] 			= "|cff68ccef".."/chatmod editboxkeys 不按住<ALT>键就能用方向键做编辑";
	SCCN_HELP[14] 			= "|cff68ccef".."/chatmod chatstring 简化密语字串。";
	SCCN_HELP[15] 			= "|cff68ccef".."/chatmod selfhighlightmsg 包含自己名字的对话消息会另外显示在屏幕上方，须开启 /chatmod selfhighlight";	
	SCCN_HELP[16]			= "|cff68ccef".."/chatmod hidechatbuttons 隐藏聊天按钮";	
	SCCN_HELP[17]			= "|cff68ccef".."/chatmod highlight 在聊天中高亮显示自定义词";	
	SCCN_HELP[18]			= "|cff68ccef".."/chatmod AutoBGMap 战场迷你地图自动弹出";	
	SCCN_HELP[19]			= "|cff68ccef".."/chatmod shortchanname 显示简略频道名";
	SCCN_HELP[22]			= "|cff68ccef".."/chatmod inchathighlight 高亮已知昵称";	
	SCCN_HELP[23]			= "|cff68ccef".."/chatmod sticky 置顶聊天信息";	
	SCCN_HELP[24]			= "|cff68ccef".."/chatmod initchan <channelname> 设置指定的< channelname >默认聊天框启动";
	SCCN_HELP[25]			= "|cff68ccef".."/chatmod nofade 禁用聊天文本的渐隐";
	SCCN_HELP[26]			= "|cff68ccef".."/chatmod autoSendWho 切换自动查询未知职业开关";
	SCCN_HELP[99]			= "|cff68ccef".."/chatmod status 显示目前设置。";
	SCCN_CMDSTATUS[1]		= "隐藏频道名称:";
	SCCN_CMDSTATUS[2]		= "按职业颜色显示玩家姓名:";
	SCCN_CMDSTATUS[3]		= "使用鼠标滚轮上下翻页:";
	...
	SCCN_CMDSTATUS[22]		= "自动查询";
	-- cursom invite word in the local language
	SCCN_CUSTOM_INV[0]		= "邀请";
	SCCN_CUSTOM_INV[1] 		= "组";
	SCCN_CUSTOM_INV[2] 		= "组我";
	SCCN_CUSTOM_INV[3] 		= "组下";
	SCCN_CUSTOM_INV[4] 		= "组一下";
	-- Whispers customized
...
--==============
	...
	--new
	Error_Filter = "Filte"
	ERRORREDIRECT_COMBOTEXT = { "Disable", "Enable, no redirect", "Enable, redirect to general log", "Enable, redirect to combat log" };
end
