...
AtlasLoot_Data["AtlasLootWorldEvents"] = {
	...
	Winterviel1 = {
		...
		{ 0,"","","" },
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Gaily Wrapped Present"], "" },
		...
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Festive Gift"], "" },
		{ 21328, "INV_Wand_02", "=q1=Wand of Holiday Cheer", "=ds=#m33#" },
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Smokywood Pastures Extra-Special Gift"], "" },
		...
		{ 0,"","","" },
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Gently Shaken Gift"], "" },
		{ 21235, "INV_Misc_Food_50", "=q1=Winter Veil Roast", "=ds=#e2#" },
		{ 21241, "INV_Drink_16", "=q1=Winter Veil Eggnog", "=ds=#e3#" },
	};
	Winterviel2 = {
		{ 0, "INV_Holiday_Christmas_Present_01", "=q6="..AL["Smokywood Pastures Vendor"], "" },
