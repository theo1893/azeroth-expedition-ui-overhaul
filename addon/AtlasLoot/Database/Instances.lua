...
AtlasLoot_Data["AtlasLootItems"] = {
	...
	MCMajordomo = {
		...
		{ 0,"","","" },
		{ 42180, "INV_Misc_Gem_01", "=q4=扭曲裂隙水晶", "=ds=#m3#", "30%" },
		{ 42178, "INV_Misc_Book_01", "=q4=复活仪式典籍", "=ds=#m3#", "30%" },
	};
	MCRagnaros = {
	...
	Onyxia = {
		...
		{ 15410, "INV_Misc_MonsterScales_07","=q3=Scale of Onyxia", "=ds=#e12# =q5="..AL["skinning"].." (315)" },
		{ 15138, "INV_Misc_Cape_05","=q3=Onyxia Scale Cloak","=q1=#m4# =ds=#s4# =q5="..AL["Leatherworking"].." (300)" },
	};
	ZGJeklik = {
 ...
 ZGEnchants = {
	...
	AQ40Viscidus = {
		...
		{ 20928, "INV_Qiraj_BindingsCommand", "=q4=Qiraji Bindings of Command", "=q17=#c9#=ds=, =q14=#c2#=ds=, =q12=#c6#=ds=, =q9=#c5#", "100%", "", "", "", "", "", "", "", "", "", "",{
				{{21330,"=q4=#x29#=ds=, #r1#"},{21367,"=q4=#x29#=ds=, #r1#"},{21361,"=q4=#x29#=ds=, #r1#"},{21350,"=q4=#x29#=ds=, #r1#"},{47215,"=q4=#x29#=ds=, #r1#"},{33017,"=q4=#x29#=ds=, #r1#"},},
				{{21333,"=q4=#x29#=ds=, #r1#"},{21365,"=q4=#x29#=ds=, #r1#"},{21359,"=q4=#x29#=ds=, #r1#"},{21349,"=q4=#x29#=ds=, #r1#"},{47218,"=q4=#x29#=ds=, #r1#"},{33020,"=q4=#x29#=ds=, #r1#"},},
			},
		},
	...
	AQ40CThun = {
		...
		{ 0,"","","" },
		{ 36550, "INV_Mount_PinkTiger", "=q4=斑点其拉作战坦克", "=ds=#e7#", "1%" },
	};
	...
	GnTrash = {
		...
		{ 0,"","","" },
		{ 42180, "INV_Misc_Gem_01", "=q3=扭曲裂隙水晶", "=ds=#m3#", "100%" },
		{ 42178, "INV_Misc_Book_01", "=q3=复活仪式典籍", "=ds=#m3#", "100%" },
	};
	SWStTargorr = {
	...
	GCMarshalMagnusGreystone = {
		...
		{ 113, "INV_Scroll_03", "=q2=设计图:真银带扣", "=ds=#s1#" },
		{ 0, "", "", "" },
	...
	HQHighForemanBargulBlackhammer = {
		...
		{ 0, "", "", "" },
		{ 56106, "INV_Misc_Book_09", "=q3=高级宝石学II的上半部分","=ds=Boss边上拾取" },
		{ 0, "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "5%" },
	};
	HQEngineerFiggles = {
	...
	HQTrash = {
		...
		{ 60572, "INV_Shoulder_23", "=q3=Incendosaur Skin Pauldrons", "=ds=#s3#, #a2#, "..AL["From Elites Outside Dungeon"], "0.1%" },
	...
	BRDTheldren = {
		{ 0, "INV_Misc_Bag_09", "=q6=#j3#", "=q6="..AL["Arena Spoils"] },
	...
	BRDTheVault = {
		{ 0, "INV_Box_01", "=q6="..AL["Dark Keeper"], "" },
		{ 11197, "INV_Misc_Key_11", "=q1=Dark Keeper Key", "=ds=#e14#", "100%" },
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6="..AL["The Secret Safe"], "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6="..AL["Relic Coffer"], "" },
		...
		{ 0, "", "", "" },
		{ 0, "INV_Box_01", "=q6="..AL["Dark Coffer"], "" },
	...
	BRDTomb = {
		{ 0, "INV_Box_01", "=q6="..AL["Chest of The Seven"], "" },
	...
	BRDEmperorDagranThaurissan = {
		...
		{ 56104, "INV_Misc_Book_09", "=q3=高级宝石学I的下半部分", "" },
	};
	BRDPrincess = {
	...
	DMEIsalien = {
		{ 0, "INV_Misc_Bag_09", "=q6=#j3#", "=q5="..AL["Isalien"] },
	...
	DMWIllyannaRavenoak = {
		...
		{ 42334, "inv_pants_04", "=q3=蓝图：星羽箭", "=ds=#p16# (300)", "1%" },
		{ 0, "", "", "" },
	...
	UBRSValthalak = {
		{ 0, "INV_Misc_Bag_09", "=q6=#j3#", "=q5="..AL["Lord Valthalak"] },
	...
	STRATCrimsonHammersmith = {
		...
		{ 124, "INV_Scroll_05", "=q3=设计图：魔化瑟银带扣", "=ds=#p2# (285)" },
		{ 0,"","","" },
	...
	STRATCannonMasterWilley = {
		...
		{ 53018, "INV_Scroll_03", "=q3=结构图：魔化瑟银弹", "=ds=#p5# (300)" },
		{ 0, "", "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "5%" },
	};
	STRATArchivistGalford = {
	...
	LBRSVoone = {
		...
		{ 0, "", "", "", "" },
		{ 56105, "INV_Misc_Book_09", "=q3=高级宝石学I的上半部分",  "=ds=Boss边上拾取" },
		{ 0, "", "", "", "" },
	...
	LBRSGrayhoof = {
		{ 0, "INV_Misc_Bag_09", "=q6=#j3#", "=q5="..AL["Mor Grayhoof"] },
	...
	LBRSZigris = {
		...
		{ 56101, "INV_Misc_Book_09", "=q3=高级金匠学I的下半部分", "=ds=#s4#", "" },
		{ 0, "", "", "", "" },
		{ 51217, "INV_misc_ribbon_01", "=q2=Fashion Coin", "=ds=#e27#", "5%" },
	};
	LBRSSlavener = {
	...
	SCHOLOKormok = {
		{ 0, "INV_Misc_Bag_09", "=q6=#j3#", "=q5="..AL["Kormok"] },
	...
	SCHOLODarkmasterGandling = {
		...
		{ 56107, "INV_Misc_Book_09", "=q3=高级宝石学II的下半部分", "" },
		{ 0, "", "", "", "" },
	...
	NAXPatchwerk =		{
		...
		{ 22961, "INV_Jewelry_Ring_49Naxxramas", "=q4=Band of Reanimation", "=ds=#s13#", "20%" },
	...
	NAXAnubRekhan = {
		...
		{ 0, "", "", "" },
		{ 42167, "INV_Misc_Book_01", "=q5=地穴领主的呼唤", "=ds=#m3#", "30%" },
	};
	NAXGrandWidowFaerlina = {
		{ 22726, "INV_Qiraj_JewelBlessed", "=q5=Splinter of Atiesh", "=q9=#c5#=ds=, =q10=#c3#=ds=, =q11=#c8#=ds=, =q13=#c1#", "30%" },
		{ 22727, "INV_Staff_20", "=q5=Frame of Atiesh", "=ds=#m2#" },
	...
	NAXKelThuzard = {
		...
		{ 22632, "INV_Staff_Medivh", "=q5=Atiesh, Greatstaff of the Guardian", "=q1=#m4# =ds=#w9# =q13=#c1#" },
		{ 0, "", "", "" },
		{ 36666, "INV_Mount_UndeadHorse", "=q4=瘟疫骑乘蜘蛛", "=ds=#e7#", "1%" },
	};
	NAXTrash = {
	...
	LKHTrash = {
		...
		{ 0, "", "", "" },
		{ 92002, "INV_Misc_Book_07", "=q3=Tome of Portals: Theramore", "=q8=#m7#, =ds=#e20# =q10=#c3#" , "0.32%" },
		{ 92004, "INV_Misc_Book_07", "=q3=Tome of Portals: Stonard", "=q6=#m6#, =ds=#e20# =q10=#c3#", "0.32%" },
		{ 0, "", "", "" },
	...
	ESHardMode = {
		...
		{ 61197, "INV_Stone_05", "=q3=Fading Dream Fragment", "", "48%" },
		{ 0, "", "", "" },
		{ 42165, "INV_Misc_Book_01", "=q4=伊瑟拉的哀鸣", "=ds=#m3#", "30%" },
	};
	ESTrash = {
	...
	UKHSanvTasdal = {
		...
		{ 55485, "INV_Shoulder_17", "=q4=Shifting Mantle of Conquest", "=q17=#c9#=ds=, =q9=#c5#=ds=, =q11=#c8#, =q13=#c1#", "50%", "", "", "", "", "", "", "", "", "", "", {
			{ { 47271, "=ds=#s3#, #a4#" }, }, -- war
			{ { 47229, "=ds=#s3#, #a1#" }, { 47235, "=ds=#s3#, #a1#" }, { 33172, "=ds=#s5#, #a1#" }}, -- priest
