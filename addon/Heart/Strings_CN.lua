...
C_Natures_swiftness = "自然迅捷"; -- 德鲁伊版本
C_Shaman_Ancestral_swiftness = "先祖迅捷"; -- 萨满祭司版本
C_Phase_shift = "相位变换";
...
BINDING_NAME_HEART_P1_1 = "小队1自定义1";
BINDING_NAME_HEART_P1_2 = "小队1自定义2";
BINDING_NAME_HEART_P2_1 = "小队2自定义1";
BINDING_NAME_HEART_P2_2 = "小队2自定义2";
BINDING_NAME_HEART_P3_1 = "小队3自定义1";
BINDING_NAME_HEART_P3_2 = "小队3自定义2";
BINDING_NAME_HEART_P4_1 = "小队4自定义1";
BINDING_NAME_HEART_P4_2 = "小队4自定义2";
...
-- keys thingy
Heart_GUI_keys = {"关闭", "无", "Alt", "Ctrl", "Shift", "Alt + Ctrl", "Alt + Shift", "Ctrl + Shift", "全部"}
...
Heart_GUI_custom_1 = "自定义1"
Heart_GUI_custom_2 = "自定义2"
...
Heart_GUI_bop_priority = "保护 优先级降低"
Heart_GUI_pws_priority = "盾 优先级降低"
Heart_GUI_rb_priority = "绷带 优先级提升"
Heart_GUI_ws_priority = "灵魂虚弱 优先级提升"
Heart_GUI_ms_priority = "致死 优先级提升"
...
-- settings
Heart_GUI_hook_useaction = "播报用户动作"
Heart_GUI_ninja_useaction = "接管用户普通技能"
Heart_GUI_hook_shields = "接管用户盾类法术"
Heart_GUI_useaction_wounded = "动作条按钮治疗最受伤目标"
Heart_GUI_shapeshifted_druids = "变形小D当作贼/战士";
Heart_GUI_safe_cancel = "过量取消治疗"
Heart_GUI_always_tank_target = "强制满级法术"
Heart_GUI_scale_spells = "自动法术等级"
Heart_GUI_scale_hots="自动恢复类法术等级"
...
Heart_GUI_show_heal_bars = "显示他人治疗条"
Heart_GUI_show_current_heal_bars = "显示当前治疗条"
Heart_GUI_show_spell_rank_heal = "法术等级 治疗量预估"
Heart_GUI_show_target_health = "法术目标 当前生命值"
Heart_GUI_show_after_health = "预计治疗后生命值"
Heart_GUI_show_overheal = "预计过量治疗值"
...
Heart_about_text="/script Heart_HealMostWounded(\"方案名\") 治疗你设置的方案里优先级最高的目标 团补命令 \n/script Heart_ActionHeal(\"方案名\") Heart_ActionHeal 的逻辑是 先检查自己的施法状态 然后查看溢出 然后 第一优先级是 坦克目标 然后是自己 再是目标 （如果目标是敌方就关注目标的目标） 没有目标执行 Heart_HealMostWounded 的逻辑 \n/script Heart_HealMostWoundedMS(\"方案名\") 牧师智能判断范围团补技能施放 需要 unitxp 支持 \n 命令行 /heart gui 来打开按钮面板；/heart opt 设置面板；/heart help 命令行用法。"
