...
C_Natures_swiftness = "Nature's Swiftness"; -- Druid version
C_Shaman_Ancestral_swiftness = "Ancestral Swiftness"; -- Shaman version
...
Heart_GUI_heal_count = "heal count"
Heart_GUI_Im_the_fastest = "I'm the fastest"
