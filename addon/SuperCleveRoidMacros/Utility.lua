...
function CleveRoids.StripRank(name)
    ...
    cached = gsub(name, "%s*"..CleveRoids.Localized.SpellRank, "") -- 修复多语言支持 by 武藤纯子酱 2026.3.12
...
local SPLIT_CC_SPELL_NAMES = {
    [CleveRoids.Localized.Spells["Master Strike"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.1.16
}
...
function CleveRoids.GetGUID(unit)
	if not unit or type(unit) ~= "string" or unit == "focus" or unit == "cursor" or unit == "cursive" or unit == "mostwoundedparty" or unit == "mostwoundedraid" or unit == "mostwounded" or unit == "filterparty" or unit == "filterraid" or unit == "filter" or unit == "inherit" or not UnitExists(unit) then -- 修复关键字过滤，避免报错 by 武藤纯子酱 2026.3.5
		return nil
	end
...
local function ParseChannelDurationFromText(text)
    ...
    local _, _, dur = string.find(text, CleveRoids.Localized.SpellDuration["for"]) -- 新增多语言支持 by 武藤纯子酱 2025.12.11
    if dur then
        return tonumber(dur)
    end
    -- Match "over X sec" pattern (some DoT/HoT tooltips)
    local _, _, over = string.find(text, CleveRoids.Localized.SpellDuration["over"]) -- 新增多语言支持 by 武藤纯子酱 2025.12.11
    if over then
        return tonumber(over)
    end
    duration = string.match(text, CleveRoids.Localized.SpellDuration["per"]) -- 新增多语言支持 by 武藤纯子酱 2025.12.26
    if duration then
        return tonumber(duration)
    end
    duration = string.match(text, CleveRoids.Localized.SpellDuration["sec"]) -- 新增多语言支持 by 武藤纯子酱 2025.12.26
    if duration then
        return tonumber(duration)
    end
    return nil
  ...
  local function apply(unit)
    if _G.SetMouseoverUnit then
      ...
      if unit == "focus" then
		...
		elseif unit == "focus" and FocusCore then -- 修复focus报错 by 武藤纯子酱 2026.3.3
		  resolved = select(2, FocusCore:GetName())
        else
...
lib.uniqueDebuffs = lib.uniqueDebuffs or {
  [CleveRoids.Localized.Spells["Hunter's Mark"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Scorpid Sting"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Weakness"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Recklessness"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of the Elements"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Shadow"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Tongues"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Idiocy"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Agony"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Doom"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Curse of Exhaustion"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Judgement of Light"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Judgement of Wisdom"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Judgement of Justice"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Judgement of the Crusader"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Shadow Vulnerability"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Shadow Weaving"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Stormstrike"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Sunder Armor"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Expose Armor"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Nightfall"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Improved Scorch"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Winter's Chill"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
}
...
lib.debuffOverwritePairs = lib.debuffOverwritePairs or {
  ...
  [CleveRoids.Localized.Spells["Faerie Fire"]] = CleveRoids.Localized.Spells["Faerie Fire (Feral)"], -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Faerie Fire (Feral)"]] = CleveRoids.Localized.Spells["Faerie Fire"], -- 修复多语言支持 by 武藤纯子酱 2026.2.1

  -- Demo variants
  [CleveRoids.Localized.Spells["Demoralizing Shout"]] = CleveRoids.Localized.Spells["Demoralizing Roar"], -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Demoralizing Roar"]] = CleveRoids.Localized.Spells["Demoralizing Shout"], -- 修复多语言支持 by 武藤纯子酱 2026.2.1
}

-- Combo point abilities: Duration depends on combo points used
lib.combopointAbilities = lib.combopointAbilities or {
  [CleveRoids.Localized.Spells["Rip"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Rupture"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Kidney Shot"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Slice and Dice"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  [CleveRoids.Localized.Spells["Expose Armor"]] = true, -- 修复多语言支持 by 武藤纯子酱 2026.2.1
}
...
function lib:ProcessMissReason(verifyData)
  ...
  if reason == CleveRoids.Localized.CombatLogs["immune"] then -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  ...
  elseif reason == CleveRoids.Localized.CombatLogs["reflect"] then -- 修复多语言支持 by 武藤纯子酱 2026.2.1
  ...
  elseif reason == CleveRoids.Localized.CombatLogs["evade"] then -- 修复多语言支持 by 武藤纯子酱 2026.2.1
...
function lib:AddEffect(guid, unitName, spellID, duration, stacks, caster)
  ...
  if caster == "player" and not lib.hasPfUIEnhanced then
    ...
    if spellName then
      ...
      local rankNum = spellRankStr and tonumber((string.gsub(spellRankStr, CleveRoids.Localized.SpellRanks["Rank "], ""))) or 0 -- 修复多语言支持 by 武藤纯子酱 2026.4.2
...
lib.trackedAfflictions = {
  ...
  [CleveRoids.Localized.Spells["Pounce"]] = { type = "cc", value = "stun" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30

  -- Bleed effects (visible debuff, but combat log is more reliable)
  [CleveRoids.Localized.Spells["Pounce Bleed"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Rake"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Rip"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Lacerate"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Garrote"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Rupture"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Deep Wound"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Deep Wounds"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
  [CleveRoids.Localized.Spells["Rend"]] = { type = "school", value = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.30
}
    ...
    if rec and rec.duration and rec.start then
      ...
      if remaining > 0 then
        ...
        if not CleveRoids.hasPfUI76 and pfUI and pfUI.api and pfUI.api.libdebuff then
          ...
          local baseName = CleveRoids.StripRank(ripSpellName) or CleveRoids.Localized.Spells["Rip"] -- 修复多语言支持 by 武藤纯子酱 2025.12.1
    ...
    if rec and rec.duration and rec.start then
      ...
      if remaining > 0 then
        ...
        if not CleveRoids.hasPfUI76 and pfUI and pfUI.api and pfUI.api.libdebuff then
          ...
          local baseName = CleveRoids.StripRank(rakeSpellName) or CleveRoids.Localized.Spells["Rake"] -- 修复多语言支持 by 武藤纯子酱 2025.12.1
      ...
      if elapsed >= 0.5 then
        ...
        if currentTargetGUID == pending.targetGUID then
          ...
          for slot = 1, 16 do
            ...
            if debuffName and _string_find(strlower(debuffName), CleveRoids.Localized.SpellSchool["judgment"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.3
          ...
          if not isWhitelisted then
            ...
            if _IsUnitDead(verifyUnit) then
              ...
              if pending.verifiedByAffliction then
                ...
                if debug then
                  local spellNameDebug = _GetSpellRecField(pending.spellID, "name") or CleveRoids.Localized.SpellSchool["bleed"] -- 修复多语言支持 by 武藤纯子酱 2025.1.9
                  DEFAULT_CHAT_FRAME:AddMessage(
                ...
                if timeSinceCast < ONE_SHOT_THRESHOLD then
                  ...
                  debuffVerified = false
                  if debug then
                    local spellNameForImmunity = _GetSpellRecField(pending.spellID, "name") or CleveRoids.Localized.SpellSchool["bleed"] -- 修复多语言支持 by 武藤纯子酱 2025.1.9
                    DEFAULT_CHAT_FRAME:AddMessage(
              ...
              if not debuffVerified then
                ...
                elseif totalDebuffs < DEBUFF_CAP_THRESHOLD then
                  ...
                  if pending.targetName and pending.targetName ~= "" then
                    ...
                    local spellNameForImmunity = _GetSpellRecField(pending.spellID, "name") or CleveRoids.Localized.SpellSchool["bleed"] -- 修复多语言支持 by 武藤纯子酱 2025.12.29
          ...
          if lib.ownDebuffs and pending.targetGUID then
            ...
            if spellName then
              ...
              if existing and existing.rank and existing.spellId and existing.spellId ~= pending.spellID then
                ...
                local pendingRank = pendingRankStr and tonumber((string.gsub(pendingRankStr, CleveRoids.Localized.SpellRanks["Rank "], ""))) or 0 -- 修复多语言支持 by 武藤纯子酱 2026.4.2
...
ev:SetScript("OnEvent", function()
          ...
          if isPersonal then
            ...
            if rankCheck == true then
              ...
              if not isJudgementCast and CleveRoids.playerClass == "PALADIN" then
                ...
                isJudgementCast = castName and _string_find(castName, "^"..CleveRoids.Localized.Spells["Judgement"]) -- 新增多语言支持 by 武藤纯子酱 2026.2.19
              end
        ...
        if isPersonal then
          ...
          if rankCheck == true then
            ...
            if not isJudgementCast and CleveRoids.playerClass == "PALADIN" then
              ...
              isJudgementCast = castName and string.find(castName, CleveRoids.Localized.Spells["Judgement"]) -- 修复多语言支持 by 武藤纯子酱 2026.3.4
            end
            if CleveRoids.playerClass == "PALADIN" and isJudgementCast then
              table.insert(lib.pendingJudgements, {
                timestamp = GetTime(),
  ...
  elseif event == "AURA_CAST_ON_SELF" or event == "AURA_CAST_ON_OTHER" then
    ...
    if spellRankStr and spellRankStr ~= "" then
      rankNum = tonumber((string.gsub(spellRankStr, CleveRoids.Localized.SpellRanks["Rank "], ""))) or 0 -- 修复多语言支持 by 武藤纯子酱 2026.4.2
    end
...
evLearn:SetScript("OnEvent", function()
  ...
  if event == "CHAT_MSG_SPELL_SELF_DAMAGE" then
    ...
    local spell_failed_tests = {
      CleveRoids.Localized.SpellFailedTests["resisted"],		-- resist				-- 修复多语言支持 by 武藤纯子酱 2025.12.2
      CleveRoids.Localized.SpellFailedTests["missed"],			-- miss					-- 修复多语言支持 by 武藤纯子酱 2025.12.2
      CleveRoids.Localized.SpellFailedTests["parried"],			-- parry (is, not was)	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
      CleveRoids.Localized.SpellFailedTests["dodged"],			-- dodge				-- 修复多语言支持 by 武藤纯子酱 2025.12.2
      CleveRoids.Localized.SpellFailedTests["blocked"],			-- full block			-- 修复多语言支持 by 武藤纯子酱 2025.12.2
      CleveRoids.Localized.SpellFailedTests["immune"],			-- immune				-- 修复多语言支持 by 武藤纯子酱 2025.12.2
    }
    ...
    if spellName and targetName then
      ...
      local isSpellFailure = find(message, CleveRoids.Localized.SpellFailedTests["dodged"]) or find(message, CleveRoids.Localized.SpellFailedTests["parried"]) or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                              find(message, CleveRoids.Localized.SpellFailedTests["blocked"]) or find(message, CleveRoids.Localized.SpellFailedTests["missed"]) or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                              find(message, CleveRoids.Localized.SpellFailedTests["resisted"]) or find(message, CleveRoids.Localized.SpellFailedTests["immune"])	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
        ...
        for i, pending in ipairs(lib.pendingCCDebuffs) do
          ...
          if pendingSpellName then
            ...
            if lower(pendingSpellName) == lower(messageSpellName) then
              ...
              if CleveRoids.debug then
                local failType = find(message, CleveRoids.Localized.SpellFailedTests["dodged"]) and CleveRoids.Localized.SpellFailedTests["dodged"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                                  find(message, CleveRoids.Localized.SpellFailedTests["parried"]) and CleveRoids.Localized.SpellFailedTests["parried"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                                  find(message, CleveRoids.Localized.SpellFailedTests["blocked"]) and CleveRoids.Localized.SpellFailedTests["blocked"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                                  find(message, CleveRoids.Localized.SpellFailedTests["resisted"]) and CleveRoids.Localized.SpellFailedTests["resisted"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                                  find(message, CleveRoids.Localized.SpellFailedTests["immune"]) and CleveRoids.Localized.CombatLogs["immune"] or CleveRoids.Localized.SpellFailedTests["missed"]	-- 修复多语言支持 by 武藤纯子酱 2025.12.30
                DEFAULT_CHAT_FRAME:AddMessage(
              ...
              for _, sid in ipairs(matchingSpellIDs) do
                if lib.objects[targetGUID][sid] then
                  ...
                  if rec.start and (GetTime() - rec.start) < 1.0 then
                    ...
                    if CleveRoids.debug then
                      local failType = find(message, CleveRoids.Localized.CombatLogs["resist"]) and CleveRoids.Localized.SpellFailedTests["resisted"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
                                       find(message, CleveRoids.Localized.CombatLogs["miss"]) and CleveRoids.Localized.SpellFailedTests["missed"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
                                       find(message, CleveRoids.Localized.CombatLogs["dodge"]) and CleveRoids.Localized.SpellFailedTests["dodged"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
                                       find(message, CleveRoids.Localized.CombatLogs["parry"]) and CleveRoids.Localized.SpellFailedTests["parried"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
                                       find(message, CleveRoids.Localized.CombatLogs["block"]) and CleveRoids.Localized.SpellFailedTests["blocked"] or	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
                                       find(message, CleveRoids.Localized.CombatLogs["immune"]) and CleveRoids.Localized.SpellFailedTests["immune"] or CleveRoids.Localized.CombatLogs["failed"]	-- 修复多语言支持 by 武藤纯子酱 2025.12.2
    ...
    if CleveRoids.lastMoltenBlastTime and CleveRoids.lastMoltenBlastTargetGUID then
      ...
      if timeSinceCast < 1.0 then
        ...
        if find(message, CleveRoids.Localized.Spells["Molten Blast"]) and find(message, CleveRoids.Localized.CombatLogs["Fire damage"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.29
...
evJudgement:SetScript("OnEvent", function()
  ...
  local hasHit = string.find(lowerMsg, CleveRoids.Localized.CombatLogs["hit"]) or string.find(lowerMsg, CleveRoids.Localized.CombatLogs["crit"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
CleveRoids.talentModifiers[1943] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end }  -- Rupture Rank 1 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[8639] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end }  -- Rupture Rank 2 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[8640] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end }  -- Rupture Rank 3 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11273] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end } -- Rupture Rank 4 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11274] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end } -- Rupture Rank 5 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11275] = { tab = 1, id = 10, talent = CleveRoids.Localized.talentModifiers["Taste for Blood"], modifier = function(base, rank) return base + (rank * 2) end } -- Rupture Rank 6 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
CleveRoids.talentModifiers[1776] = { tab = 3, id = 3, talent = CleveRoids.Localized.talentModifiers["Improved Gouge"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Gouge Rank 1 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[1777] = { tab = 3, id = 3, talent = CleveRoids.Localized.talentModifiers["Improved Gouge"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Gouge Rank 2 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[8629] = { tab = 3, id = 3, talent = CleveRoids.Localized.talentModifiers["Improved Gouge"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Gouge Rank 3 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11285] = { tab = 3, id = 3, talent = CleveRoids.Localized.talentModifiers["Improved Gouge"], modifier = function(base, rank) return base + (rank * 0.5) end } -- Gouge Rank 4 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11286] = { tab = 3, id = 3, talent = CleveRoids.Localized.talentModifiers["Improved Gouge"], modifier = function(base, rank) return base + (rank * 0.5) end } -- Gouge Rank 5 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
CleveRoids.talentModifiers[589] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }    -- SW:P Rank 1 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[594] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }    -- SW:P Rank 2 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[970] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }    -- SW:P Rank 3 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[992] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }    -- SW:P Rank 4 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[2767] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }   -- SW:P Rank 5 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[10892] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }  -- SW:P Rank 6 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[10893] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }  -- SW:P Rank 7 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[10894] = { tab = 3, id = 4, talent = CleveRoids.Localized.talentModifiers["Improved Shadow Word: Pain"], modifier = function(base, rank) return base + (rank * 3) end }  -- SW:P Rank 8 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
CleveRoids.talentModifiers[5211] = { tab = 2, id = 4, talent = CleveRoids.Localized.talentModifiers["Brutal Impact"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Bash Rank 1 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[6798] = { tab = 2, id = 4, talent = CleveRoids.Localized.talentModifiers["Brutal Impact"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Bash Rank 2 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[8983] = { tab = 2, id = 4, talent = CleveRoids.Localized.talentModifiers["Brutal Impact"], modifier = function(base, rank) return base + (rank * 0.5) end }  -- Bash Rank 3 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
CleveRoids.talentModifiers[1160] = { tab = 2, id = 1, talent = CleveRoids.Localized.talentModifiers["Booming Voice"], modifier = boomingVoiceModifier }   -- Demoralizing Shout Rank 1 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[6190] = { tab = 2, id = 1, talent = CleveRoids.Localized.talentModifiers["Booming Voice"], modifier = boomingVoiceModifier }   -- Demoralizing Shout Rank 2 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11554] = { tab = 2, id = 1, talent = CleveRoids.Localized.talentModifiers["Booming Voice"], modifier = boomingVoiceModifier }  -- Demoralizing Shout Rank 3 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11555] = { tab = 2, id = 1, talent = CleveRoids.Localized.talentModifiers["Booming Voice"], modifier = boomingVoiceModifier }  -- Demoralizing Shout Rank 4 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
CleveRoids.talentModifiers[11556] = { tab = 2, id = 1, talent = CleveRoids.Localized.talentModifiers["Booming Voice"], modifier = boomingVoiceModifier }  -- Demoralizing Shout Rank 5 -- 修复多语言支持 by 武藤纯子酱 2025.12.2
...
local SPLIT_DAMAGE_SPELLS = {
    [CleveRoids.Localized.Spells["Rake"]] = { initial = "physical", debuff = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Pounce"]] = { initial = "physical", debuff = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Garrote"]] = { initial = "physical", debuff = "bleed" }, -- 修复多语言支持 by 武藤纯子酱 2025.12.2
}
...
local KNOWN_NON_DAMAGING_SPELLS = {
    -- Druid
    [CleveRoids.Localized.Spells["Faerie Fire"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Faerie Fire (Feral)"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.29
    [CleveRoids.Localized.Spells["Faerie Fire (Bear)"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.29
    [CleveRoids.Localized.Spells["Moonfire"]] = "arcane",  -- Initial hit deals damage, but debuff is arcane -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Insect Swarm"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Abolish Poison"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Remove Curse"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Pounce Bleed"]] = "bleed",  -- Triggered by Pounce (9005→9007, 9823→9824, 9827→9826)

    -- Mage
    [CleveRoids.Localized.Spells["Amplify Magic"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Dampen Magic"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Remove Lesser Curse"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Slow Fall"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Detect Magic"]] = "arcane", -- 修复多语言支持 by 武藤纯子酱 2025.12.2

    -- Priest
    [CleveRoids.Localized.Spells["Dispel Magic"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Cure Disease"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Abolish Disease"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Power Word: Fortitude"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Power Word: Shield"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Divine Spirit"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Fear Ward"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Resurrection"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2

    -- Paladin
    [CleveRoids.Localized.Spells["Cleanse"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Purify"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Divine Protection"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Divine Shield"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Blessing of Protection"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Blessing of Freedom"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Blessing of Sacrifice"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Redemption"]] = "holy", -- 修复多语言支持 by 武藤纯子酱 2025.12.2

    -- Warlock
    [CleveRoids.Localized.Spells["Banish"]] = "shadow", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Curse of Weakness"]] = "shadow", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Curse of Recklessness"]] = "shadow", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Curse of Tongues"]] = "shadow", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Amplify Curse"]] = "shadow", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Death Coil"]] = "shadow",  -- Has damage component but often used for CC -- 修复多语言支持 by 武藤纯子酱 2025.12.2

    -- Shaman
    [CleveRoids.Localized.Spells["Cure Poison"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Cure Disease"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Purge"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Ancestral Spirit"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2

    -- Hunter
    [CleveRoids.Localized.Spells["Aspect of the Hawk"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Aspect of the Monkey"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Aspect of the Cheetah"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Aspect of the Pack"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    [CleveRoids.Localized.Spells["Aspect of the Wild"]] = "nature", -- 修复多语言支持 by 武藤纯子酱 2025.12.2
}
...
local function OnSpellDamageEvent()
    ...
    if schoolName == "physical" then
        local spellName = GetSpellRecField and GetSpellRecField(spellId, "name")
        if spellName then
            local baseName = CleveRoids.StripRank(spellName) -- 修复多语言支持 by 武藤纯子酱 2026.1.7
			if not baseName then return nil end -- 修复nil报错 by 武藤纯子酱 2026.1.8
            local lower = string.lower(baseName)
            if string.find(lower, string.lower(CleveRoids.Localized.Spells["Rip"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Rake"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Rupture"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Garrote"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Rend"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Deep Wound"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Hemorrhage"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Pounce"])) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                schoolName = "bleed"
            end
        end
    end
...
local function GetSpellSchool(spellName, spellID)
    ...
    local baseName = nil
    if spellName then
        baseName = CleveRoids.StripRank(spellName) -- 修复多语言支持 by 武藤纯子酱 2026.1.10
    elseif spellID and GetSpellRecField then
        local fullName = GetSpellRecField(spellID, "name")
        if fullName then
            baseName = CleveRoids.StripRank(fullName) -- 修复多语言支持 by 武藤纯子酱 2026.1.10
        end
    end
    ...
    if spell then
        ...
        for i = 1, CleveRoidsSchoolTooltip:NumLines() do
            ...
            if line then
                ...
                if string.find(text, CleveRoids.Localized.SpellSchool["bleed"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                    school = "bleed"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["fire"]) or string.find(text, CleveRoids.Localized.SpellSchool["flame"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                    school = "fire"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["frost"]) or -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                       string.find(text, "^"..CleveRoids.Localized.SpellSchool["ice"].."[^%a]") or string.find(text, "[^%a]"..CleveRoids.Localized.SpellSchool["ice"].."[^%a]") or string.find(text, "[^%a]"..CleveRoids.Localized.SpellSchool["ice"].."$") then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                    school = "frost"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["nature"]) or string.find(text, CleveRoids.Localized.SpellSchool["poison"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                    school = "nature"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["shadow"]) or string.find(text, CleveRoids.Localized.SpellSchool["dark"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                    school = "shadow"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["arcane"]) then
                    school = "arcane"
                    break
                elseif string.find(text, CleveRoids.Localized.SpellSchool["holy"]) or string.find(text, CleveRoids.Localized.SpellSchool["divine"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
                    school = "holy"
                    break
                end
            end
    ...
    if not school then
        ...
        -- Arcane
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["arcane"]) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Polymorph"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Mana Burn"])) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "arcane"

        -- Nature: Faerie Fire (check before "fire" to avoid false positive)
        elseif string.find(lower, string.lower(CleveRoids.Localized.Spells["Faerie Fire"])) then -- 修复多语言支持 by 武藤纯子酱 2026.2.1
            school = "nature"

        -- Fire (specific patterns to avoid false positives)
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["^fire"]) or string.find(lower, CleveRoids.Localized.SpellSchool[" fire"]) or  -- Starts with or contains " fire" -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, CleveRoids.Localized.SpellSchool["flame"]) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Immolat"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Scorch"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Pyroblast"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Ignite"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Combustion"])) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "fire"
        ...
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["frost"]) or -- 修复多语言支持 by 武藤纯子酱 2026.3.28
               string.find(lower, "^"..CleveRoids.Localized.SpellSchool["ice"].."[^%a]") or string.find(lower, "[^%a]"..CleveRoids.Localized.SpellSchool["ice"].."[^%a]") or string.find(lower, "[^%a]"..CleveRoids.Localized.SpellSchool["ice"].."$") or -- 修复多语言支持 by 武藤纯子酱 2026.3.28
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Blizzard"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Freeze"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, CleveRoids.Localized.SpellSchool["chill"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "frost"

        -- Nature
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["nature"]) or string.find(lower, CleveRoids.Localized.SpellSchool["poison"]) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, CleveRoids.Localized.SpellSchool["sting"]) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Wrath"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Starfire"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Thorns"])) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "nature"

        -- Shadow
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["shadow"]) or string.find(lower, CleveRoids.Localized.SpellSchool["curse"]) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Corruption"])) or string.find(lower, CleveRoids.Localized.SpellSchool["drain"]) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, CleveRoids.Localized.SpellSchool["vampir"]) or string.find(lower, CleveRoids.Localized.SpellSchool["affliction"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "shadow"

        -- Holy
        elseif string.find(lower, CleveRoids.Localized.SpellSchool["holy"]) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Smite"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, string.lower(CleveRoids.Localized.Spells["Exorcism"])) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Consecrat"])) or -- 修复多语言支持 by 武藤纯子酱 2025.12.2
               string.find(lower, CleveRoids.Localized.SpellSchool["judgment"]) or string.find(lower, string.lower(CleveRoids.Localized.Spells["Hammer of Wrath"])) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            school = "holy"
...
local function CancelPendingVerification(targetName, spellName)
    ...
    local lowerSpell = spellName and string.lower(CleveRoids.StripRank(spellName)) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
        ...
        for i, pending in ipairs(lib.pendingCCDebuffs) do
            ...
            if pending.targetName and string.lower(pending.targetName) == lowerTarget then
                if lowerSpell then
                    ...
                    local pendingSpellName = pending.spellName and string.lower(CleveRoids.StripRank(pending.spellName)) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
        ...
        for i, pending in ipairs(lib.pendingSharedDebuffs) do
            ...
            if pending.targetName and string.lower(pending.targetName) == lowerTarget then
                if lowerSpell then
                    ...
                    pendingSpellName = pendingSpellName and string.lower(CleveRoids.StripRank(pendingSpellName)) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
                    if pendingSpellName and pendingSpellName == lowerSpell then
                        matches = true
                    end
                else
        ...
        for i, pending in ipairs(lib.pendingPersonalDebuffs) do
            ...
            if pending.targetName and string.lower(pending.targetName) == lowerTarget then
                if lowerSpell then
                    ...
                    pendingSpellName = pendingSpellName and string.lower(CleveRoids.StripRank(pendingSpellName)) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
                    local castSpellName = pending.castSpellID and GetSpellRecField(pending.castSpellID, "name")
                    castSpellName = castSpellName and string.lower(CleveRoids.StripRank(castSpellName)) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
...
local function ParseImmunityCombatLog()
    ...
    local hasImmune = string.find(message, CleveRoids.Localized.CombatLogs["immune"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    local hasReflect = string.find(message, CleveRoids.Localized.CombatLogs["reflect"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    local hasEvade = string.find(message, CleveRoids.Localized.CombatLogs["evade"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
    ...
    if hasImmune then
        missReason = CleveRoids.Localized.CombatLogs["immune"] -- 修复多语言支持 by 武藤纯子酱 2026.2.1
    elseif hasReflect then
        missReason = CleveRoids.Localized.CombatLogs["reflect"] -- 修复多语言支持 by 武藤纯子酱 2026.2.1
    elseif hasEvade then
        missReason = CleveRoids.Localized.CombatLogs["evade"] -- 修复多语言支持 by 武藤纯子酱 2026.2.1
    end
    ...
    if hasImmune then
        ...
        local _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["immune_2"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        ...
        if not spellName or not targetName then
            _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["immune_3"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedSpell and extractedTarget then
                spellName = extractedSpell
                targetName = extractedTarget
            end
        ...
        if not targetName then
            _, _, extractedTarget = string.find(message,  CleveRoids.Localized.SpellFailedTests["immune_4"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        ...
        if not targetName then
            _, _, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["immune_5"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedTarget then
                targetName = extractedTarget
            end
        end
    ...
    if hasReflect and not targetName then
        ...
        local _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["reflect_1"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        if extractedSpell and extractedTarget then
            spellName = extractedSpell
            targetName = extractedTarget
        end
        ...
        if not spellName or not targetName then
            _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["reflect_2"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedSpell and extractedTarget then
                spellName = extractedSpell
                targetName = extractedTarget
            end
        ...
        if not targetName then
            _, _, extractedTarget, extractedSpell = string.find(message, CleveRoids.Localized.SpellFailedTests["reflect_3"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        ...
        if not targetName then
            _, _, extractedTarget, extractedSpell = string.find(message, CleveRoids.Localized.SpellFailedTests["reflect_4"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedTarget and extractedSpell then
                targetName = extractedTarget
                spellName = extractedSpell
            end
    ...
    if hasEvade and not targetName then
        ...
        local _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["evade_1"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        if extractedSpell and extractedTarget then
            spellName = extractedSpell
            targetName = extractedTarget
        end
        ...
        if not spellName or not targetName then
            _, _, extractedSpell, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["evade_2"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedSpell and extractedTarget then
                spellName = extractedSpell
                targetName = extractedTarget
            end
        ...
        if not targetName then
            _, _, extractedTarget, extractedSpell = string.find(message, CleveRoids.Localized.SpellFailedTests["evade_3"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedTarget and extractedSpell then
                targetName = extractedTarget
                spellName = extractedSpell
            end
        ...
        if not targetName then
            _, _, extractedTarget = string.find(message, CleveRoids.Localized.SpellFailedTests["evade_4"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.2
            if extractedTarget then
                targetName = extractedTarget
            end
        end
    ...
    if string.find(message, CleveRoids.Localized.SpellFailedTests["immune_6"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.2
        local _, immuneEnd = string.find(message, CleveRoids.Localized.SpellFailedTests["immune_7"]) -- 修复多语言支持 by 武藤纯子酱 2026.3.28
        if immuneEnd then
            local schoolText = string.lower(string.sub(message, immuneEnd + 1))
            if string.find(schoolText, CleveRoids.Localized.SpellSchool["fire"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "fire"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["frost"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "frost"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["nature"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "nature"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["shadow"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "shadow"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["arcane"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "arcane"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["holy"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "holy"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["physical"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "physical"
            elseif string.find(schoolText, CleveRoids.Localized.SpellSchool["bleed"]) then -- 修复多语言支持 by 武藤纯子酱 2026.3.28
                school = "bleed"
            end
        end
    end
...
local function ParseAfflictedCombatLog()
    ...
    if not string.find(message, CleveRoids.Localized.CombatLogs["afflicted by"]) then return end -- 修复多语言支持 by 武藤纯子酱 2025.12.30

    -- Pattern: "X is afflicted by Y" or "X is afflicted by Y (N)."
    -- Handle both with and without trailing period
    local _, _, targetName, spellName = string.find(message, CleveRoids.Localized.CombatLogs["^(.-)%s+is afflicted by%s+(.+)"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.30
            ...
            for _, pending in ipairs(lib.pendingPersonalDebuffs) do
                if pending.targetName == targetName and not pending.verifiedByAffliction then
                    ...
                    if pendingSpellName then
                        ...
                        pendingSpellName = CleveRoids.StripRank(pendingSpellName) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
                        local afflictionSpellName = CleveRoids.StripRank(spellName) -- 修复多语言支持 by 武藤纯子酱 2026.1.9
...
function CleveRoids.CheckImmunity(unitId, spellOrSchool)
    ...
    if IMMUNITY_SCHOOLS[inputLower] then
        ...
        local baseName = CleveRoids.StripRank(spellOrSchool) -- 修复多语言支持 by 武藤纯子酱 2026.1.10
...
local reactivePatterns = {
    [CleveRoids.Localized.Spells["Overpower"]] = { -- 新增多语言支持 by 武藤纯子酱 2026.2.21
        patterns = ENEMY_DODGE_PATTERNS,
        type = "enemy_dodge",
        requiresTargetGUID = true,
        duration = 4.0
    },
    [CleveRoids.Localized.Spells["Surprise Attack"]] = { -- 新增多语言支持 by 武藤纯子酱 2026.2.21
        patterns = ENEMY_DODGE_PATTERNS,
        type = "enemy_dodge",
        requiresTargetGUID = true,
        duration = 4.0
    },
    [CleveRoids.Localized.Spells["Riposte"]] = { -- 新增多语言支持 by 武藤纯子酱 2026.2.21
    ...
    [CleveRoids.Localized.Spells["Revenge"]] = { -- 新增多语言支持 by 武藤纯子酱 2026.2.21
...
function CleveRoids.ParseReactiveCombatLog(lowerMsg)
	...
	local message = arg2 -- 修复，应为arg2 by 武藤纯子酱 2025.12.25
    ...
    if not (strfind(lowerMsg, CleveRoids.Localized.CombatLogs["dodge"]) or strfind(lowerMsg, CleveRoids.Localized.CombatLogs["parry"]) or strfind(lowerMsg, CleveRoids.Localized.CombatLogs["block"])) then -- 修复多语言支持 by 武藤纯子酱 2026.1.7
        return
    end
...
function CleveRoids.ProcessAutoAttackEvent(isPlayerAttacker, attackerGuid, targetGuid, totalDamage, hitInfo, victimState)
    ...
    if isPlayerAttacker and victimState == VICTIMSTATE_DODGE then
        ...
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Overpower"]] then -- 新增多语言支持 by 武藤纯子酱 2026.2.2
            -- Overpower requires targeting the mob that dodged
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Overpower"], 4.0, targetGuid) -- 新增多语言支持 by 武藤纯子酱 2026.2.2
            CleveRoids.QueueActionUpdate()
    ...
    if not isPlayerAttacker and targetGuid == playerGUID and victimState == VICTIMSTATE_PARRY then
        ...
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Riposte"]] then -- 新增多语言支持 by 武藤纯子酱 2026.2.2
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Riposte"], 4.0, attackerGuid) -- 新增多语言支持 by 武藤纯子酱 2026.2.2
            CleveRoids.QueueActionUpdate()
            if CleveRoids.debug then
                DEFAULT_CHAT_FRAME:AddMessage(
        ...
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Surprise Attack"]] then -- 新增多语言支持 by 武藤纯子酱 2026.2.21
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Surprise Attack"], 4.0, targetGuid) -- 新增多语言支持 by 武藤纯子酱 2026.2.21
            CleveRoids.QueueActionUpdate()
            if CleveRoids.debug then
                DEFAULT_CHAT_FRAME:AddMessage(
    ...
    if not isPlayerAttacker and targetGuid == playerGUID then
        ...
        if isAvoidance then
            if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Revenge"]] then -- 新增多语言支持 by 武藤纯子酱 2026.2.2
                -- Revenge can be used on any target once procced
                CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Revenge"], 4.0, nil) -- 新增多语言支持 by 武藤纯子酱 2026.2.2
                CleveRoids.QueueActionUpdate()
...
local function ProcessSpellMissSelf(spellId, targetGuid, missInfo)
    ...
    local baseName = spellName and CleveRoids.StripRank(spellName) or nil -- 修复多语言支持 by 武藤纯子酱 2026.2.12
    ...
    if missInfo == MISSINFO_IMMUNE or missInfo == MISSINFO_IMMUNE2 then
        ...
        if targetName and spellName then
            ...
            lib.recentCombatLogReasons[targetName][spellName] = {
                time = GetTime(),
                reason = CleveRoids.Localized.CombatLogs["immune"], -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            }
        end
    ...
    if missInfo == MISSINFO_REFLECT then
        ...
        if targetName and spellName then
            ...
            lib.recentCombatLogReasons[targetName][spellName] = {
                time = GetTime(),
                reason = CleveRoids.Localized.CombatLogs["reflect"], -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            }
        end
        return
    end
    ...
    if missInfo == MISSINFO_EVADE then
        ...
        if targetName and spellName then
            ...
            lib.recentCombatLogReasons[targetName][spellName] = {
                time = GetTime(),
                reason = CleveRoids.Localized.CombatLogs["evade"], -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            }
        end
        return
    end
    ...
    if missInfo == MISSINFO_DODGE then
        ...
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Overpower"]] then -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Overpower"], 4.0, targetGuid) -- 修复多语言支持 by 武藤纯子酱 2026.2.12
        end

        -- Surprise Attack proc (same trigger as Overpower - enemy dodged)
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Surprise Attack"]] then -- 修复多语言支持 by 武藤纯子酱 2026.2.21
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Surprise Attack"], 4.0, targetGuid) -- 修复多语言支持 by 武藤纯子酱 2026.2.21
        end
...
local function ProcessSpellMissOther(spellId, casterGuid, targetGuid, missInfo)
    ...
    if missInfo == MISSINFO_DODGE then
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Revenge"]] then -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Revenge"], 4.0, nil) -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            CleveRoids.QueueActionUpdate()
    ...
    if missInfo == MISSINFO_PARRY then
        if CleveRoids.reactiveSpells and CleveRoids.reactiveSpells[CleveRoids.Localized.Spells["Riposte"]] then -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            CleveRoids.SetReactiveProc(CleveRoids.Localized.Spells["Riposte"], 4.0, casterGuid) -- 修复多语言支持 by 武藤纯子酱 2026.2.12
            CleveRoids.QueueActionUpdate()
...
reactiveFrame:SetScript("OnEvent", function()
    ...
    if event == "AUTO_ATTACK_SELF" then
        ...
        CleveRoids.ProcessAutoAttackEvent(true, attackerGuid, targetGuid, totalDamage, hitInfo, victimState) -- 将false 改为 true，表明这是自己的平砍 by 武藤纯子酱 2026.3.1
...
local function ParseResistCombatLog(lowerMsg)
    ...
    if not string.find(lowerMsg, CleveRoids.Localized.CombatLogs["resist"]) then return end -- 修复多语言支持 by 武藤纯子酱 2025.12.25
    ...
    if not string.find(message, targetGUID, 1, true) then -- 用targetGUID替换targetName by 武藤纯子酱 2025.12.25
    ...
    local isPartial = string.find(message,  CleveRoids.Localized.CombatLogs["resisted%)"]) -- 修复多语言支持 by 武藤纯子酱 2025.12.25
    ...
    if not isPartial then
        if string.find(message, CleveRoids.Localized.SpellFailedTests["resisted"]) or string.find(message, CleveRoids.Localized.SpellFailedTests["resisted_2"]) then -- 修复多语言支持 by 武藤纯子酱 2025.12.25
            isFull = true
        end
    end
...
local function HandleDebuffFade()
    ...
    if not find(raw, CleveRoids.Localized.CombatLogs["fades from"]) then return end  -- 修复多语言支持 by 武藤纯子酱 2026.2.1

    --local _, _, spellName = find(raw, "^(.-) fades from ")
    --local _, _, targetGUID = find(raw, "from (.-).$")
	local _, _, spellName, targetGUID = find(raw, CleveRoids.Localized.CombatLogs["(.+) fades from (.+)"])  -- 修复多语言支持 by 武藤纯子酱 2026.2.1

    if lower(targetGUID or "") == CleveRoids.Localized.CombatLogs["you"] then  -- 修复多语言支持 by 武藤纯子酱 2026.2.1
...
unifiedCombatLogFrame:SetScript("OnEvent", function()
    ...
    if raw and string.len(raw) >= 12 and find(raw, CleveRoids.Localized.CombatLogs["fades from"]) then -- 修复多语言支持 by 武藤纯子酱 2026.2.10
        HandleDebuffFade()
    end
    ...
    if find(msg, CleveRoids.Localized.CombatLogs["immune"]) or find(msg, CleveRoids.Localized.CombatLogs["reflect"]) or find(msg, CleveRoids.Localized.CombatLogs["evade"]) then -- 修复多语言支持 by 武藤纯子酱 2026.2.10
        ParseImmunityCombatLog()
    end

    -- 3. "Afflicted by" detection for hidden CC (e.g., Pounce stun)
    if find(msg, CleveRoids.Localized.CombatLogs["afflicted by"]) then -- 修复多语言支持 by 武藤纯子酱 2026.2.10
        ParseAfflictedCombatLog()
    end
    ...
    if strfind(lowerMsg, CleveRoids.Localized.CombatLogs["dodge"]) or strfind(lowerMsg, CleveRoids.Localized.CombatLogs["parry"]) or strfind(lowerMsg, CleveRoids.Localized.CombatLogs["block"]) then -- 修复多语言支持 by 武藤纯子酱 2026.2.10
        CleveRoids.ParseReactiveCombatLog(lowerMsg)
    end

    -- 5. Resist tracking
    if msgLen >= 15 and strfind(lowerMsg, CleveRoids.Localized.CombatLogs["resist"]) then -- 修复多语言支持 by 武藤纯子酱 2026.2.10
