...
$attemptRoot = Join-Path $repoRoot 'generated\quests\QL-B0\v2\backplates\attempt-04'
$executorRoot = Join-Path $attemptRoot 'executor'
$childRoot = Join-Path $repoRoot 'generated\quests\QL-B0\v2\fixed-b-attempt-04'
...
if (-not $match.Success) {
    throw 'Unable to extract the authorized QL-B0-B V2 execution body.'
}
