...
def main() -> None:
    ...
    require(
        ...
        "QS-B1 V5-A attempt 3 review and r3 repair gate",
    )
    require(
        progress,
        (
            ...
            "internal-rejected / repair-prepared / P3 / production\n3/5",
            "paint-only regenerate 已修复规则微纹",
            "两个局部 dim plane",
            "紧邻 attempt 3 raw",
        ),
        "QS-B1 V5-A attempt 3 progress gate",
    )
    require(
        seals_work,
        (
