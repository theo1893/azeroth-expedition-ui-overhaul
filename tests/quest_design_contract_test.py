...
def main() -> None:
    ...
    require(
        ...
        "QS-B1 V5-A attempt 1 review and r1 repair gate",
    )
    require(
        progress,
        (
            ...
            "internal-rejected / repair-prepared / P3 / production 1/5",
            "自动 `18/18`、六态布局 `29/29` 与 display-region `6/6`",
            "完整 V5-A.r1 已准备为受限",
            "attempt 1 raw Image 3 执行 attempt 2 edit",
        ),
        "QS-B1 V5-A attempt 1 progress gate",
    )
    require(
        seals_work,
        (
