...
| 任务 | `QL-A1` 空卷宗透明源母版达到 `P4`；`QL-A2 V1` 已退回，八对象 `V2.1` 透明候选达到 `P3`；追踪器仅保留 `P2` 视觉，外部 provider 兼容为 `P0` | 用户视觉复审 `QL-A2 V2.1`；追踪器等待外部插件源码 |
...
| `2026-07-29` | 任务模块范围收敛 | 通过静态检查 | [`QUEST_COMPONENT_SPEC.md`](QUEST_COMPONENT_SPEC.md) 保留 Quest Log 对象合同和 questitem 行为；原生 QuestWatch provider 假设已撤销，外部追踪插件待后续审计；`QL-A1` 已确认，`QL-A2 V1` 已退回，`QL-A2 V2.1` 等待视觉复审 |
...
| `QUEST.LOG.SHELL` | 双页卷宗封皮、包角与外围页叠 | `QuestLogFrame` | adapter | `P4 QL-A1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A1 production V1](../../prompts/quests/任务详情空卷宗结构母版_生产提示词_QL-A1_v1.md) | [QL-A1 manifest](../../assets/source/quests/ql-a1/QL-A1_SourceManifest_v1.json)；尚无 runtime | 整图不得作为背景；八对象候选确认和实机测量后才定义切片 |
| `QUEST.LOG.LIST.PAPER` | 左页目录连续纸面 | `QuestLogListScrollFrame` 外围呈现层 | adapter | `P4 QL-A1／P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | V2.1 左页候选 `654 × 620`；近等宽物理页重组通过；无 tracked source／runtime | 用户复审暗暖赭纸面；runtime 左文字安全区目标 `42%` |
| `QUEST.LOG.DETAIL.PAPER` | 右页正文连续纸面 | `QuestLogDetailScrollFrame` | adapter | `P4 QL-A1／P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | V2.1 右页候选 `657 × 617`；近等宽物理页重组通过；无 tracked source／runtime | 用户复审稍亮旧象牙纸面；runtime 右文字安全区目标 `58%` |
...
| `QUEST.LOG.GUTTER.UNDERLAY` | 凹陷内部页沟底层 | `QuestLogFrame` 中央非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `104 × 299`；中心最暗、两侧渐隐；无 tracked source／runtime | 用户复审；实机高度后定义纵向周期 |
| `QUEST.LOG.GUTTER.LEFT_FOLD` | 左页内折过渡 | 左页内缘非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `91 × 291`；纸面之后覆盖；无 tracked source／runtime | 用户复审内缘转折与暖色清理 |
| `QUEST.LOG.GUTTER.RIGHT_FOLD` | 右页内折过渡 | 右页内缘非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `84 × 289`；与左内折镜像光照；无 tracked source／runtime | 用户复审内缘转折与暖色清理 |
| `QUEST.LOG.GUTTER.STITCH` | 内部装订缝线周期 | 页沟中央非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `76 × 251`；只有麻线，无皮革底板；无 tracked source／runtime | 用户复审；接受后据实提取重复相位 |
| `QUEST.LOG.GUTTER.TOP` | 顶部小型装订收口 | 页沟顶端非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `150 × 53`；只占中央窄缝；无 tracked source／runtime | 用户复审；不得扩展成横向头冠 |
| `QUEST.LOG.GUTTER.BOTTOM` | 底部小型装订收口 | 页沟底端非交互 Texture | adapter | `P3 QL-A2 V2.1` | [QL-A1 源母版](../../assets/source/quests/ql-a1/QuestLogBookShell_Master_v1.png) | [QL-A2 production V2](../../prompts/quests/任务详情内页沟结构部件_生产提示词_QL-A2_v2.md)；[V2.1 修订](../../prompts/quests/任务详情内页沟结构部件_修订提示词_QL-A2_v2.1.md) | 本地候选 `123 × 47`；不含底部页块；无 tracked source／runtime | 用户复审；不得扩展成横梁或端帽 |
