...
来源的旧 AEUI 满格显示一次性迁移，不写类别 profile。`fieldkit-contract=2.2` 完整延续 v1.5，把每个 A／B 口袋放入
...
- `战斗甲板`：Bar 1 为屏幕中下部居中 `12×1` 主栏；Bar 6 为其上方 `12×1`
  ...
  已按游戏坐标收紧停靠，bridge-v2.2 继承 v1.9 的无文字／动态收缩布局，并把
