...
### `QL-D V3.r1` production prompt

Fresh-regenerate exactly one isolated production raster asset for Turtle WoW
1.18.1: one rough field-added quartermaster equipment docket hand-fastened
into the formal Azeroth quest ledger. This is a new generation from fixed
Image 1 and Image 2 only. Do not use, edit, imitate or preserve pixels from the
rejected previous candidate: its miniature-open-book identity, centered
book-spine cadence, three equal horizontal loops, dense cross-hatched surface,
right-field ornaments, green fringe and 2.571:1 silhouette are all rejected.

The new result is one connected empty normal-state chassis for one read-only
`QuestLogItem` reward Button, displayed at exactly 108 x 41 UI pixels. The live
game owns the 33 x 33 item icon in runtime [4,4,37,37], its quantity, the
dynamic item name in [41,4,105,37], item-quality colour, tooltip and click
behavior. Generate no second slot, reward group, state sheet, selected state,
icon, placeholder, count, item name, quality glow, text, glyph, tooltip or
other live content.

Reference authority is strict. Image 1 together with the Azeroth Expedition
and Quest art baselines is the highest authority. Inherit only its circa-2004
vanilla World of Warcraft low-resolution 2D hand-painted bitmap language:
thick imperfect contours, broad readable light/mid/shadow planes, tangible
material thickness, warm upper-left light, muted smoked ochre, umber,
dark-walnut and nearly blackened old-bronze colours, restrained broad wear and
world-used guild-archive weight. Do not copy its book, pages, quest rows,
plaque, compass, wax seal, ribbons, buttons, text, icons, borders or layout.
Image 2 is secondary adjacency calibration only: inherit its accepted Quest
Log parchment temperature, paint scale, edge softness, upper-left light,
dark-walnut relationship and wear scale. Do not copy its book silhouette,
page outlines, gutter, spine, stitches, brass corners, transparency or pixels.
Image 1 plus the global and Quest baselines wins every conflict. Do not use
simulation pixels, V2 candidates, screenshots or any previous QL-D output.

The direct result must be a square RGB bitmap, target exact 1024 x 1024. Every
pixel outside the object must be one uniform solid #00FF00 chroma-key colour:
no gradient, vignette, checkerboard, haze, texture, green-tinted shadow or
spill. Place one unrotated horizontal connected assembly fully inside visible
target bbox [72,345,952,679], width 880 and height 334, target aspect 2.635:1
and accepted only from 2.58:1 through 2.69:1. Make the silhouette visibly
wider and slightly shallower than the rejected 2.571:1 candidate. Include its
neutral-brown page-contact shadow inside that bbox; the shadow must not enlarge
the visible height beyond the contract. Leave clean green on all four sides.
Use straight-on orthographic front view with no tilt, foreshortening,
three-quarter angle, rotation, floating parts, non-uniform stretch, tiling,
mirroring or nine-slice assumptions.

Treat the 880 x 334 bbox as local coordinates. Keep local icon-safe
[33,33,301,301] entirely inside one quiet continuous dark-leather surface.
Keep local name-safe [334,33,856,301] entirely inside one quiet continuous
smoked-parchment surface. All rough cuts, lash holes, fasteners, fibres,
stains, highlights and edge breaks stay outside both rectangles. Reserve local
x=301..334 as the only main connection zone. The two safe regions contain no
ruling, writing, symbols, ornament, repeated grain, dense scratches or high
contrast. In particular, place no fastener in the right name-safe rectangle.

This must read as one improvised equipment docket attached to a larger quest
ledger, never as a small open book. There is no central gutter, vertical
book spine, facing-page pair, hinged cover, page turn, symmetrical left/right
composition or book-binding row. The right back layer is one long horizontal
smoked warm-parchment name strip, not a page. It runs beneath the left patch
and has asymmetrical hand-torn top and bottom margins with a few broad,
non-periodic rises and missing fibres equal to one or two runtime pixels. No
regular sawtooth, scallop, deckle template, rounded card, sticky note, dark
rectangular outline or complete border. Its central name field is an almost
plain broad value plane with at most two large soft painted value drifts and a
narrow lower-right material-thickness plane.

The front layer is one separate irregular dark-walnut leather icon patch on
the left, visibly laid over the paper joint by two to three runtime pixels. It
is a rough hand-cut near-square patch, not a book cover and not one half of a
two-page spread. Give its top and bottom edges different non-mirrored cuts,
unequal corners and a ragged overlap flap at the joint. It fully supports the
icon-safe square without drawing a precise square frame. Use a short warm
upper-left plane, broad soot-walnut middle plane and deep-umber lower-right
plane. The icon-safe interior remains plain, dark and continuous: no icon-well
outline, quality border, inset square, emblem, embossed weave, lattice or
uniform tooling.

Make the overlap physical. The paper continues behind the leather at the
joint; a narrow warm contact edge and two short deep contact pockets show the
leather sitting above it. Do not draw a straight full-height divider. Do not
make the two materials meet as equal coplanar panels. Keep the joint irregular
and subordinate so it does not resemble a book gutter.

Use exactly three isolated hand-set lash marks in the narrow joint, but never
three horizontal rings or an evenly spaced vertical binding. They must be
visibly different constructions and positions: one short upper diagonal
two-hole stitch angled down-right; one slightly lower-than-center compact
knotted bind angled up-right; one lower short slanted stitch with a different
length and thickness. Give the three unequal vertical gaps, unequal angles,
unequal lengths and unequal silhouettes. Each locally pierces or cinches the
overlap and shares the material contact shadow. None may cross either safe
rectangle or form a decorative row.

Add exactly two small mismatched nearly blackened oxidized-bronze peripheral
retention marks, both outside the safe rectangles and neither at matching
coordinates. Put one shallow irregular dull fastener only in the narrow upper
paper margin above local y=33; put the other different wedge-like mark only in
the lower paper margin below local y=301. Keep them inset from the far-right
corner and visually quieter than live text. They are not rivets, jewellery,
corner brackets, bright gold trim or a metal border.

Use broad low-frequency hand-painted planes only. At 108 x 41, the leather,
paper, overlap and three different stitches must remain separable. Put
controlled handmade irregularity only in the outer silhouette, a few broken
dry-brush edge strokes, the overlap, the three lashes, peripheral broad wear
and the two fasteners. Leave large calm fields. Absolutely no all-over fibre
mesh, woven pattern, crosshatch, dense crackle, tiny repeated scratches,
procedural grunge, embossed tooling, pencil rendering, comic line art,
scrapbook cutout or modern indie-game sketch card. It must feel repaired by an
Azeroth quartermaster and painted by the same 2004-era UI artists as the Quest
Log, not photographed and not vector-clean.

Add one very narrow irregular soft neutral-brown contact shadow immediately
below and to the right of the connected assembly, equal to one or two runtime
pixels and fully inside the target bbox. It seats the docket on the accepted
page and reinforces paper-under-leather overlap. It must not be black, green,
floating, photorealistic or detached. Preserve warm upper-left light and a
deeper lower-right contact throughout.

Strict exclusions: miniature open book, open-book spread, book cover, facing
pages, spine, gutter, hinge, centered binding row, three equal loops, evenly
spaced stitches, complete leather chassis, continuous leather frame,
continuous brass or gold outline, enclosing rim, mirrored chamfers, equal
corners, symmetric fasteners, precision inner border, modern HUD rail, rounded
card, capsule, pill, mobile label, sticky note, scrapbook sticker, vector
outline, dense microtexture, crosshatch, glass, translucent black, neon,
polished gold, gemstone, buckle, wax seal, ribbon, bookmark, compass, quill,
rune, emblem, letters, numerals, glyphs, icon, item silhouette, quantity,
quality colour, selection glow, extra state, multiple objects, full book,
page frame, Diablo altar, skull, spike, demonic horn or Skyrim minimalist UI.

Before returning, inspect the actual direct image at both full size and an
imagined 108 x 41 reduction. Verify: square RGB target 1024 x 1024; one
connected empty normal-state equipment docket; uniform #00FF00 outside with no
green fringe; entire object and neutral shadow inside [72,345,952,679]; visible
aspect 2.58..2.69 and clearly wider than 2.571:1; straight orthographic view;
one paper strip below one overlapping leather patch, with no book or gutter
reading; quiet local icon-safe [33,33,301,301] and name-safe
[334,33,856,301]; exactly three isolated unequal non-ring lash marks; exactly
two mismatched peripheral dark-bronze marks outside safe areas; broad plain
...
### `QL-D V3.r3` production prompt

Fresh-regenerate exactly one isolated production raster asset for Turtle WoW
1.18.1 from fixed Image 1 and Image 2 only. Create one rough field-added
quartermaster equipment docket hand-fastened into the formal Azeroth quest
ledger. This is a completely fresh generation. Do not upload, edit, trace or
reuse either previous candidate. Preserve only the written conclusions: the
asset is one paper strip below one leather icon patch, uses broad nearly plain
painted material planes, three practical unequal ties and two peripheral dark
fasteners. Attempt 3's art direction is useful, but its 2.489:1 silhouette was
far too tall and its deep edge cuts made both live safe areas incomplete.

This one connected empty normal-state chassis is displayed at exactly 108 x 41
UI pixels for one read-only `QuestLogItem` reward Button. The game owns the 33
x 33 live item icon in runtime [4,4,37,37], quantity, dynamic item name in
[41,4,105,37], item-quality colour, tooltip and click behavior. Draw exactly
one empty object. Draw no second slot, reward group, state sheet, selected
state, icon, placeholder, count, name, text, glyph, quality glow or tooltip.

Image 1 together with the Azeroth Expedition global and Quest art baselines is
the highest authority. Inherit only its circa-2004 vanilla World of Warcraft
low-resolution 2D hand-painted bitmap language: thick imperfect contours,
broad light/mid/shadow planes, physical material thickness, warm upper-left
light, muted smoked ochre, umber, dark walnut and nearly blackened old bronze,
restrained broad wear and world-used expedition weight. Ignore and do not copy
its book, pages, rows, plaque, compass, seal, ribbons, buttons, text, icons,
borders or layout. Image 2 is secondary adjacency calibration only: inherit
accepted Quest Log parchment temperature, paint scale, edge softness, upper-
left light, dark-walnut relationship and wear scale. Do not copy its book
silhouette, pages, gutter, spine, stitches, brass corners, transparency or
pixels. Image 1 plus the written baselines wins every conflict. Do not use
simulation pixels, V2 assets, screenshots or any previous QL-D output.

The direct result must be a square RGB bitmap, target exact 1024 x 1024. Every
pixel outside the assembly is one uniform solid #00FF00 chroma key, with no
gradient, vignette, haze, checkerboard, texture, green-tinted shadow or spill.
Place exactly one unrotated horizontal connected assembly within full visible
contract bbox [72,345,952,679], width 880, height 334, target 2.635:1 and
accepted only from 2.58:1 through 2.69:1. It must look unmistakably long and
low, significantly thinner vertically than the rejected attempt 3. Use a
straight-on orthographic front view with no tilt, foreshortening, three-
quarter angle, rotation, floating parts, stretch, tile, mirror or nine-slice.

Use a two-envelope occupancy construction. The main opaque leather and paper
faces must stay inside canvas [72,355,952,669], an 880 x 314 long-low body with
about 2.80:1 body aspect. Only a few shallow torn fibres, short thickness
planes and the neutral contact shadow may extend from that body into the outer
contract margin [72,345,952,679]. Those small extensions must make the final
measured visible bbox approximately 880 x 330 to 334, never taller than 341.
No large peak, deep notch, knot tail or shadow may increase the total height.
If the object seems visually too thin, keep it thin; do not thicken it.

Treat [72,345,952,679] as a local 880 x 334 system. The complete local icon-
safe rectangle [33,33,301,301] must be one fully opaque, quiet, continuous
dark-leather plane. The complete local name-safe [334,33,856,301] must be one
fully opaque, quiet, continuous smoked-parchment plane. Target 100 percent
coverage for both; acceptance is at least 98 percent. No green, transparency,
tear, cutout, notch, lash hole, fastener, knot tail, stain, highlight or shadow
may enter either rectangle. Reserve local x=301..334 as the only connection
zone. Do not place live-safe content near an uncertain silhouette edge.

The asset is one improvised equipment docket, never a miniature book. There is
no cover, facing-page pair, central gutter, spine, hinge, page turn, symmetric
spread or binding row. The back layer is one long horizontal smoked warm-
parchment name strip on the right. The front layer is one rough dark-walnut
leather icon patch on the left, laid over the paper joint by two to three
runtime pixels. The paper continues behind the patch. The materials are not
equal coplanar panels.

Keep the parchment face extremely simple: one quiet flat ochre midtone across
at least eighty percent of its face, one broad warm upper-left wash, one broad
darker lower-right wash and a narrow thickness plane. No visible fibre mesh,
embossed swirls, crosshatch, weave, pebbling, crackle, flecks, repeated grain,
scratch field or procedural noise. The future name area must be calmer than
the accepted quest page.

Make both long paper edges mostly straight. Allow only four very shallow
asymmetrical events outside the safe rectangle: one upper nick no deeper than
10 source pixels, one different upper soft rise no higher than 8 pixels, and
two unequal lower breaks no deeper than 10 pixels. Each event is broad and
separated by a long straight run. Absolutely no 20-to-40-pixel peak, deep V
notch, bottom scallop, repeated wave, sawtooth or regular deckle. Keep the far-
right top and bottom corners within the same shallow body band.

Make the left leather patch a slightly irregular near-square occupying about
the first 31 to 34 percent of total width, enough to fully cover local
x=33..301 but not half the docket. Its top and bottom stay within the main
body band. Use unequal corners and one shallow ragged overlap flap, but no deep
concave cut. The icon-safe interior is a single uninterrupted soot-walnut
plane with a short warm upper-left plane and deep-umber lower-right plane.
Allow at most two broad peripheral wear strokes. No fibre network, crosshatch,
embossed tooling, repeating grain, icon-well outline, quality border, inset
square or emblem. It is a patch, not a book cover or framed icon slot.

Show the physical overlap with a narrow irregular warm paper lip behind the
leather joint and two short deep contact pockets. Do not draw a straight full-
height divider, gutter or complete joint outline. Keep all joint detail inside
local x=301..334 and out of both safe rectangles.

Add exactly three compact practical hand-set lash marks in the joint. Use dark
aged cord or leather, not bright brass. Make one short upper diagonal two-hole
stitch, one off-centre compact single knot with two very short unequal tails,
and one lower slanted stitch of a different length and thickness. All three
must fit vertically within the main body band; no long hanging tail. The knot
is not a bow, butterfly, rosette or symmetrical loop. Give the three unequal
gaps, angles, lengths and silhouettes. No horizontal ring, even binding row or
safe-region intrusion.

Add exactly two tiny mismatched nearly blackened oxidized-bronze retention
marks only in the peripheral paper margin outside safe rectangles: one crude
mark above local y=33 and one different wedge below local y=301. They have
unequal x positions, stay inset from far-right corners and fit inside the full
height contract. Keep them dull and quieter than future text. No symmetric
rivets, polished gold, jewellery, corner bracket, row or metal frame.

Use broad low-frequency hand-painted decisions. At full 1024 source scale,
both material faces are already nearly plain. Handmade irregularity exists
only in four shallow edge events, a few peripheral dry-brush strokes, the
overlap, three ties and two fasteners. At 108 x 41 the two materials and ties
remain legible as a vanilla-WoW UI sprite. Do not rely on downsampling to hide
pattern. Never become photorealistic, vector-clean, procedural, precision-
industrial, scrapbook-like or a modern indie sketch card.

Add one very narrow irregular soft neutral-brown contact shadow immediately
below and right of the assembly. It is equivalent to one or two runtime
pixels, fits entirely within the outer [72,345,952,679] envelope and never
increases the total height beyond 334. It is not black, green, detached,
floating or photorealistic. Preserve warm upper-left light and deeper lower-
right contact.

Strict exclusions: tall silhouette, aspect below 2.58, incomplete safe area,
deep notch, large paper peak, long knot tail, repeated wavy perimeter, all-over
texture, crosshatch, fibre mesh, embossing, weave, repeated grain, decorative
bow, miniature book, cover, facing pages, spine, gutter, hinge, binding row,
three equal loops, complete leather chassis, continuous leather frame,
continuous brass or gold outline, enclosing rim, mirrored chamfers, equal
corners, symmetric fasteners, precision inner border, modern HUD rail, rounded
card, capsule, pill, sticky note, mobile label, scrapbook sticker, vector
outline, glass, translucent black, neon, polished gold, gemstone, buckle, wax
seal, ribbon, bookmark, compass, quill, rune, emblem, letters, numerals,
glyphs, icon, item silhouette, quantity, quality colour, selection glow,
multiple objects, full book, page frame, Diablo altar, skull, spike, demonic
horn or Skyrim overlay.

Before returning, measure the visible result rather than judging loosely.
Verify: square RGB target 1024 x 1024; exactly one connected empty normal-state
docket; pure uniform #00FF00 outside; main opaque faces inside
[72,355,952,669]; every visible extension and shadow inside
[72,345,952,679]; measured complete visible aspect 2.58..2.69 and visibly long-
low; straight orthographic view; fully opaque local icon-safe
[33,33,301,301] and name-safe [334,33,856,301]; one plain paper strip below one
plain leather patch; exactly three compact practical unequal ties with no bow;
exactly two peripheral mismatched dark marks; no deep cuts, repeated waves,
all-over texture, enclosing frame, symmetric cadence or baked live content.

### `QL-D V3.r4` production prompt

Fresh-regenerate exactly one isolated production raster asset for Turtle WoW
1.18.1 from fixed Image 1 and Image 2 only. Create one rough field-added
quartermaster equipment docket hand-fastened into the formal Azeroth quest
ledger. This is a completely fresh generation for the fifth and final actual
ImageGen call. Do not upload, edit, trace, transform or reuse any previous
QL-D candidate. Preserve only the written conclusions: one smoked-paper name
strip below one overlapping dark-leather icon patch, broad nearly plain
painted material planes, three practical unequal ties and two peripheral dark
fasteners. Attempt 4's art, material hierarchy, safe regions and runtime
legibility were acceptable, but its measured 2.769:1 silhouette was too wide.
The sole primary repair is a visibly deeper 2.635:1 chassis with exact blank
side margins; never stretch, crop or patch an earlier image to obtain it.
...
pixel outside the assembly is one uniform solid #00FF00 chroma key, with no
gradient, vignette, haze, checkerboard, texture, green-tinted shadow or spill.
Place exactly one unrotated horizontal connected assembly in the central
contract rectangle [72,345,952,679], exactly 880 wide by 334 high, target
aspect 2.635:1. The complete visible object, including every fibre, thickness
plane and neutral contact shadow, must remain inside that rectangle. Leave at
least 72 pixels of untouched green at both left and right sides, about seven
percent of the square canvas per side. Leave the large green bands above and
below. The result must not expand nearly to the canvas edges as attempt 4 did.
Accepted measured aspect is only 2.58:1 through 2.69:1. A 2.70:1 or wider
banner is a failure; a 2.57:1 or taller slab is also a failure.

Use a straight-on orthographic front view with no tilt, foreshortening, three-
quarter angle, rotation, floating parts, stretch, tile, mirror or nine-slice.
Build the main opaque paper and leather faces as a moderately low rectangle
about 880 x 325 inside [72,350,952,675], approximately 2.71:1 before edge
events. Then use only shallow material thickness, torn fibres and contact
shadow to bring the measured full silhouette toward 880 x 334 and 2.635:1.
Do not use the rejected very-thin 2.80:1 core construction. The visible height
must read as about thirty-eight percent of the visible width, not as a thin
banner. No peak, notch, knot tail or shadow may be used to fake the height.
...
leather icon patch on the left, laid over the paper joint by two to three
runtime pixels. The paper continues behind the patch. The materials are not
equal coplanar panels. The leather occupies only about the first one third of
the total width; the paper remains the clearly longer material.
...
embossed swirls, crosshatch, weave, pebbling, crackle, flecks, repeated grain,
scratch field or procedural noise. The future name area must be calmer than
the accepted quest page. Keep both long paper edges mostly straight. Allow
only four very shallow asymmetrical events outside the safe rectangle: one
upper nick no deeper than 8 source pixels, one different upper soft rise no
higher than 6 pixels, and two unequal lower breaks no deeper than 8 pixels.
Each event is broad and separated by a long straight run. No deep V notch,
bottom scallop, repeated wave, sawtooth or regular deckle.

Make the left leather patch a slightly irregular near-square occupying about
31 to 34 percent of total width, enough to fully cover local x=33..301 but not
half the docket. Its top and bottom stay within the main face band. Use unequal
corners and one shallow ragged overlap flap, but no deep concave cut. The icon-
safe interior is a single uninterrupted soot-walnut plane with one broad warm
upper-left plane and one broad deep-umber lower-right plane. Allow at most two
broad peripheral wear strokes. No fibre network, crosshatch, embossed tooling,
repeating grain, icon-well outline, quality border, inset square or emblem. It
is a patch, not a book cover or framed icon slot.

Show the physical overlap with a narrow irregular warm paper lip behind the
leather joint and two short deep contact pockets. Do not draw a straight full-
height divider, gutter or complete joint outline. Keep all joint detail inside
local x=301..334 and out of both safe rectangles. Add exactly three compact
practical hand-set lash marks in this joint. Use dark aged cord or leather,
not bright brass. Make one short upper diagonal two-hole stitch, one off-centre
compact single knot with two very short unequal tails, and one lower slanted
stitch of a different length and thickness. Give them unequal gaps, angles,
lengths and silhouettes. The knot is not a bow, butterfly, rosette or loop.
There is no long hanging tail, horizontal ring or evenly spaced binding row.

Add exactly two tiny mismatched nearly blackened oxidized-bronze retention
marks only in peripheral paper margin outside both safe rectangles: one crude
mark above local y=33 and one different wedge below local y=301. Give them
unequal x positions and keep them inset from the far-right corners. They are
dull and quieter than future text. No symmetric rivets, polished gold,
jewellery, corner bracket, row or metal frame.
...
Add one very narrow irregular soft neutral-brown contact shadow immediately
below and right of the assembly. It is equivalent to one or two runtime
pixels, fits entirely within [72,345,952,679] and does not change the measured
aspect beyond 2.58..2.69. It is not black, green, detached, floating or
photorealistic. Preserve warm upper-left light and deeper lower-right contact.

Strict exclusions: visible aspect above 2.69 or below 2.58, less than 72 green
pixels at either horizontal canvas edge, thin banner silhouette, incomplete
safe area, deep notch, large paper peak, long knot tail, repeated wavy
perimeter, all-over texture, crosshatch, fibre mesh, embossing, weave, repeated
grain, decorative bow, miniature book, cover, facing pages, spine, gutter,
hinge, binding row, three equal loops, complete leather chassis, continuous
leather frame, continuous brass or gold outline, enclosing rim, mirrored
chamfers, equal corners, symmetric fasteners, precision inner border, modern
HUD rail, rounded card, capsule, pill, sticky note, mobile label, scrapbook
sticker, vector outline, glass, translucent black, neon, polished gold,
gemstone, buckle, wax seal, ribbon, bookmark, compass, quill, rune, emblem,
letters, numerals, glyphs, icon, item silhouette, quantity, quality colour,
selection glow, multiple objects, full book, page frame, Diablo altar, skull,
spike, demonic horn or Skyrim overlay.

Before returning, measure rather than judge loosely. Verify all of the
following: square RGB target 1024 x 1024; exactly one connected empty normal-
state docket; pure uniform #00FF00 outside; at least 72 pixels green at both
left and right canvas edges; every visible pixel inside [72,345,952,679];
measured complete visible aspect 2.58..2.69 with target 2.635; straight
orthographic view; fully opaque local icon-safe [33,33,301,301] and name-safe
[334,33,856,301]; one plain long paper strip below one plain one-third-width
leather patch; exactly three compact practical unequal ties with no bow;
exactly two peripheral mismatched dark marks; no deep cuts, repeated waves,
all-over texture, enclosing frame, symmetric cadence or baked live content.
...
- attempt 1 review：
  `generated/quests/ql-d-reward-slots/production/V3/attempt-01/review/ql-d-v3-attempt-01.review.json`；
  technical `17/19`、display-region `5/5 pass`。raw 请求的 exact `1024²`／纯
  `#00FF00`／目标 bbox 均为诊断失败；正方形同轴归一合法，但不能修复错误
  aspect。视觉审查确认三条绳圈等距同形、左右材料读成封面／书页、密集规则
  交叉纹理与右侧固定件破坏 V3 物件语义。本稿不满足 Image 3 条件。
- 下一完整正文：`QL-D V3.r1`；body SHA-256
  `f65856e024882f35bbc031c9d5e2405772e7a6ee52e890a1b3873639c678235e`。它完整
...
- 下一完整正文：`QL-D V3.r2`；body SHA-256
  ...
  Image 1／2。
- attempt 3 review：
  `generated/quests/ql-d-reward-slots/production/V3/attempt-03/review/ql-d-v3-attempt-03.review.json`；
  technical `16/19`、display `5/5 pass`。attempt 3 消除了上一稿的主要全局纹理
  与周期边缘，美术基线通过；但 `946×380` keyed bbox 只有 `2.48947:1`，高度
  驱动 fit 后两块冻结 safe area 出现透明侵入。soft despill 仅改 9 个 RGB，
  不改变该几何结论。错误 aspect／safe anatomy 必须 fresh-regenerate。
- 下一完整正文：`QL-D V3.r3`；body SHA-256
  `deba614615e6e768840fbea8d3354345e614e76123df6535e6ab2be67f122d51`。它保留
  attempt 3 的 plain broad-plane 方向，并新增双包络：主体面锁在
  `[72,355,952,669]` 的 long-low body，只有浅纤维／厚度／阴影可进入外层
  `[72,345,952,679]`；深缺口、长结尾和超过 `334px` 总高度均禁止。attempt 4
  只上传固定 Image 1／2。
- attempt 4 review：
  `generated/quests/ql-d-reward-slots/production/V3/attempt-04/review/ql-d-v3-attempt-04.review.json`；
  technical `18/19`、display `5/5 pass`。本稿的物件身份、纸下皮上层序、
  低频手绘综合色、三处不等实用缝扎、两枚错位暗固定痕、icon/name safe
  Alpha `0.99919/0.99974`、四态与真实排版均通过；但 keyed bbox `961×347`
  为 `2.7694524496:1`，超过 `2.69` 硬上限。非等比压缩或裁主体均被合同禁止；
  错误比例是明确 fresh-regenerate 类别，因此本稿没有 Image 3 资格。
- 下一完整正文：`QL-D V3.r4`；body SHA-256
  `da637c8f0e11fc5a15b55c58389b95024f4ef84cbf61dd3ba0bfbaeed3b242c5`。它保留 attempt 4 已通过的身份、层序、两区
