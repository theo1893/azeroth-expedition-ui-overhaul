...
| `raid` | `UF.RAID.*` | `UF-RAID-A2-DONOR V1 / P3 prompt-authorized / attempt-01-ready / 0/5`；A1 已 5/5 rejected，A2 改用 material-only donor＋Python 精确造壳；40 个真实对象，不从主单位框缩放复制 |
