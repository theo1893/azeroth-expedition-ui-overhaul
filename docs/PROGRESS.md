...
| Quests | `questlog.lua`、`gossipquest.lua`、`questitem.lua` | `P2–P4` | 当前首要大面积 UI；QL-A1 source 已确认；QL-A2 V3.2 等待授权；外部 tracker 暂停 | 明确授权当前 V3.2-A／B work Prompt 与两张受限参考上传 |
