...
- 项目接管：pfUI `chat` 行为与 AEUI V3 单一左侧战地旧书视觉；AEUI
  ...
  四态目录墨记和 QL-B2 三态选择书签。QL-B0 V2 `18 × 18` 已开始候选循环，
  尚无 source 或 runtime 接入。
