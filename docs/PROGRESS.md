...
| Quests | `questlog.lua`、`gossipquest.lua`、`questitem.lua` | `P2–P4` | 当前首要大面积 UI；QL-A1 source 已确认；QL-A2 V3.3 已将 B 拆为 folds、stitch、closures 三个尺度族并完成 Prompt 预检，当前 `0/15`；外部 tracker 暂停 | 用户明确授权 V3.3 三段正文、固定上传范围和每段 `5` 次预算 |
