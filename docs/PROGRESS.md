...
| Quests | `questlog.lua`、`gossipquest.lua`、`questitem.lua` | `P2–P4` | 当前首要大面积 UI；QL-A1 source 已确认；QL-A2 V3.3 三段正文与固定上传范围已获授权，当前 `prompt-authorized / P3`、`0/15`；外部 tracker 暂停 | 固定执行器执行 B1 attempt 1 并完整内审 |
