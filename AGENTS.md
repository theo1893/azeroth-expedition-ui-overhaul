...
| 聊天 | 核心 V3 runtime `P5`；`CHAT.COPY.V1.1` 为 `prompt-draft / P2`；单一左框，右框隐藏 | Turtle WoW 实机验收核心批次；用户明确授权 Chat Copy V1.1 |
...
- [当前 Chat Copy V1.1 工作文件](docs/modules/chat/work/CHAT.COPY.V1.md)
