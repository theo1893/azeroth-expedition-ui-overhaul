...
| 聊天 | 核心 V3 runtime `P5`；`CHAT.COPY.V1` 为 `candidate-rejected / P3`；单一左框，右框隐藏 | Turtle WoW 实机验收核心批次；制定并授权 Chat Copy V1.1 |
...
- [当前 Chat Copy V1 工作文件](docs/modules/chat/work/CHAT.COPY.V1.md)
