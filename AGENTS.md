...
| 任务 | 当前首要大面积 UI；QL-A1 `P4`；QL-A2 V3.3 的 B1／B2 均在 `5/5` 后退回，B3 attempt 4 仅严格尺寸失败且 attempt 5 已在调用前计数，当前 `P3`、`15/15` | 用同段底稿执行 B3 attempt 5 bounded scale-down edit；整批装配仍被 B1／B2 阻塞 |
