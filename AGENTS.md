...
| 聊天 | 核心 V3 runtime `P5`；`CHAT.COPY.V1.3` 为 `candidate-rejected / P3`；单一左框，右框隐藏 | Turtle WoW 实机验收核心批次；为 Chat Copy 准备可在 `22 × 26` 辨认开合差的下一版 |
...
- [当前 Chat Copy V1.3 工作文件](docs/modules/chat/work/CHAT.COPY.V1.md)
