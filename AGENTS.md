...
| 聊天 | 核心 V3 runtime `P5`；`CHAT.COPY.V1.2` 为 `candidate-rejected / P3`；单一左框，右框隐藏 | Turtle WoW 实机验收核心批次；为 Chat Copy 建立不依赖 ImageGen 像素坐标的下一版草案 |
...
- [当前 Chat Copy V1.2 工作文件](docs/modules/chat/work/CHAT.COPY.V1.md)
