#!/usr/bin/env python3
"""Render QS-B1 V3 dynamic substrate + independent motif simulation."""
...
def substrate_art(visible_count: int, menu_open: bool) -> Image.Image:
    """One visual strip assembled from root/body/tail without slot seams."""
    width = 32
...
def draw_detail_content(
    ...
    background = substrate_art(len(state["visible_actions"]), state["menu_open"])
