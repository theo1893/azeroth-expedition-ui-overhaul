"""Export accepted distance tag at 2 texels per UI; no artwork changes."""
...
SOURCE = ROOT / 'assets/source/unitframes/distance-tag-v1'
MEDIA = ROOT / 'addon/AzerothExpeditionUI/Media/UnitFrames'
SPECS = [('tag', 'DistanceTagV1', (72, 18), (256, 64), (0, 0)),
         ('open', 'DistanceEyeOpenV1', (20, 14), (64, 32), (0, 0)),
         ('blocked', 'DistanceEyeBlockedV1', (20, 14), (64, 32), (0, 0))]
...
def main():
    ...
    data = dict(module='unitframes', component='UF.DISTANCE.TAG', phase='P5',
                status='accepted-runtime-integrated', route='unitframes.distance-indicator',
                sources=sources, runtime=runtime)
    (SOURCE/'DISTANCE-TAG-V1_RuntimeManifest.json').write_text(json.dumps(data,indent=2)+'\n', encoding='utf-8')
    print('PASS distance tag V1: 3 RGBA textures at 2 texels/UI')
